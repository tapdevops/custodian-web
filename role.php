...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_Role
				VALUES (NULL,'$_POST[txtRole_Name]','$mv_UserID', sysdate(),'$mv_UserID',
						sysdate(),NULL,NULL)";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=role.php'>";
	}
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_Role
				SET Role_Name='$_POST[txtRole_Name]', Role_Update_UserID='$mv_UserID', Role_Update_Time=sysdate()
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_Role
				SET Role_Delete_UserID='$mv_UserID', Role_Delete_Time=sysdate()
				WHERE Role_ID='$_POST[txtRole_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=role.php'>";
	}
