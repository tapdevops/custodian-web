...
function RenderCssCal(bNewCal)
{
	...
	winCalData = "<span style='cursor:auto; border:none;'>";
	vCalHeader = "<table style='background-color:"+CalBgColor+";width:200px;padding:0;margin:5px auto 5px auto; border:none;'><tbody>";

	//Table for Month & Year Selector

	vCalHeader += "<tr style='border:none;'><td colspan='7' style='border:none;'><table border='0' width='200px' cellpadding='0' cellspacing='0' style='border:none;'><tr style='border:none;'>";
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+imageFilesPath+"icon_close.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
