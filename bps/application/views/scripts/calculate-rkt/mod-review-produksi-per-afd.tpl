...
header("Content-Disposition: attachment;Filename=mod_review_produksi_afd_".date("YmdHis").".xls");
...
<div style='font-weight:bolder; font-size:12px;'>COMPANY : ".$this->data['rows'][0]['COMPANY_NAME']."</div>
<div style='font-weight:bolder; font-size:12px;'>BUSINESS AREA : ".$this->data['rows'][0]['ESTATE_NAME']."</div><br>
<table border=1>
...
if($this->data['count'] > 0){
	...
	echo "<td>".$total_yield_profile_yph."</td>";
	echo "<td>".$total_yield_profile_ton."</td>";
	echo "<td>".$total_potensi_yph."</td>";
	echo "<td>".$total_potensi_ton."</td>";
	echo "<td>".$total_budget_yph."</td>";
	echo "<td>".$total_budget_ton."</td>";
	echo "<td>".$total_var_yph."</td>";
