...
header("Content-Disposition: attachment;Filename=report_norma_pupuk_tm_".date("YmdHis").".xls");
...
// TITLE DOKUMEN
echo "
<div style='font-weight:bolder; font-size:20px;'>REPORT NORMA PUPUK TM</div><br>
";
