...
header("Content-Disposition: attachment;Filename=report_norma_pupuk_tbm_".date("YmdHis").".xls");
...
// TITLE DOKUMEN
echo "
<div style='font-weight:bolder; font-size:20px;'>REPORT NORMA PUPUK TBM</div><br>
";
