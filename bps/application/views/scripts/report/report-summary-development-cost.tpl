...
header("Content-Disposition: attachment;Filename=report_sum_development_cost_".date("YmdHis").".xls");
...
<div style='font-weight:bolder; font-size:20px;'>SUMMARY DEVELOPMENT COST</div>
