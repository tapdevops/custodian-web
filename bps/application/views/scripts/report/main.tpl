				...
				<tr>
					...
					<td>
						<select name="jenis_report" id="jenis_report" style="width:205px;" />
							...
							<option value="development_cost">REPORT - DEVELOPMENT COST (BA)</option>
							<option value="development_cost_afd">REPORT - DEVELOPMENT COST (AFD)</option>
							<option value="summary_development_cost">REPORT - SUMMARY DEVELOPMENT COST (BA)</option>
							<option value="summary_development_cost_afd">REPORT - SUMMARY DEVELOPMENT COST (AFD)</option>
							<option value="estate_cost">REPORT - ESTATE COST (BA)</option>
							<option value="estate_cost_afd">REPORT - ESTATE COST (AFD)</option>
							<option value="summary_estate_cost">REPORT - SUMMARY ESTATE COST (BA)</option>
							<option value="summary_estate_cost_afd">REPORT - SUMMARY ESTATE COST (AFD)</option>
							...
							<!--option value="report_keb_aktivitas_est_ba">REPORT KEBUTUHAN AKTIVITAS - ESTATE COST (BA)</option-->
							...
							<!--<option value="report_hk_mpp_ba">REPORT HK VS MPP (BA)</option>-->
							<!--<option value="report_hk_mpp_afd">REPORT HK VS MPP (AFD)</option>-->
							<option value="report_norma_pupuk_tbm">REPORT NORMA PUPUK TBM</option>
							<option value="report_norma_pupuk_tm">REPORT NORMA PUPUK TM</option>
							<option value="report_status_hitung">REPORT STATUS HITUNG ALL</option>
						</select>
					</td>
				</tr>				
				<tr>
		...
		if ( ( reference_role == 'BA_CODE' ) && ( region == '' ) && ( ba_code == '' ) ) {
			...
			switch(jenis_report){
				...
				case "development_cost": 
				  ...
				  break;
				case "development_cost_afd": 
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-development-cost-afd/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;  
				case "summary_development_cost":
				  ...
				  break;
				case "summary_development_cost_afd":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-summary-development-cost-afd/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;  
				case "estate_cost": 
				  ...
				  break;
				case "estate_cost_afd": 
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-estate-cost-afd/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;
				case "summary_estate_cost":
				  ...
				  break;
				case "summary_estate_cost_afd":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-summary-estate-cost-afd/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;
				case "vra_utilisasi":
				...
				case "report_keb_aktivitas_est_ba":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-keb-aktivitas-per-ba/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;  
				case "report_keb_aktivitas_est_afd":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-keb-aktivitas-per-afd/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break; 
				case "report_keb_aktivitas_dev_ba":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-keb-aktivitas-dev-per-ba/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;  
				case "report_keb_aktivitas_dev_afd":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-keb-aktivitas-dev-per-afd/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;			
				case "report_hk_mpp_ba":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-hk-mpp-ba/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;
				case "report_hk_mpp_afd":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-hk-mpp-afd/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;
				case "report_norma_pupuk_tbm":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-norma-pupuk-tbm/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;	
				case "report_norma_pupuk_tm":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-norma-pupuk-tm/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;					  
				case "report_status_hitung":
				  window.open("<?=$_SERVER['PHP_SELF']?>/report/report-status-hitung-all/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find,'_blank');
				  break;	
			}
