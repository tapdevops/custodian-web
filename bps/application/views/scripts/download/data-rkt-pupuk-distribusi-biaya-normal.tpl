...
header("Content-Disposition: attachment;Filename=data_rkt_pupuk_distribusi_biaya_normal_".date("YmdHis").".xls");
...
// TITLE DOKUMEN
echo "
<div style='font-weight:bolder; font-size:20px;'>RKT DISTRIBUSI BIAYA PUPUK - NORMAL</div><br>
";
