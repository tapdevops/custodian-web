...
header("Content-Disposition: attachment;Filename=data_rkt_kastrasi_sanitasi_".date("YmdHis").".xls");
...
// TITLE DOKUMEN
echo "
<div style='font-weight:bolder; font-size:20px;'>RKT KASTRASI SANITASI</div><br>
";
