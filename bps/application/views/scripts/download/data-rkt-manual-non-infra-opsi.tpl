...
header("Content-Disposition: attachment;Filename=data_rkt_manual_non_infra_opsi_".date("YmdHis").".xls");
...
// TITLE DOKUMEN
echo "
<div style='font-weight:bolder; font-size:20px;'>RKT MANUAL - NON INFRA (OPSI)</div><br>
";
...
<tr style='background:#999; color:#FFF; font-weight:bolder; text-align:center; vertical-align:middle;'>
	...
	<td>ROTASI SMS1</td>
	<td>ROTASI SMS2</td>
	<td>KODE OPSI AKTIVITAS</td>
	<td>DESKRIPSI OPSI AKTIVITAS</td>
	<td>SUMBER BIAYA</td>
	<td>PLAN JAN</td>
	<td>PLAN FEB</td>
	<td>PLAN MAR</td>
