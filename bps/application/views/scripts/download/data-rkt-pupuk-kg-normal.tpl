...
header("Content-Disposition: attachment;Filename=data_rkt_pupuk_kg_normal_".date("YmdHis").".xls");
...
// TITLE DOKUMEN
echo "
<div style='font-weight:bolder; font-size:20px;'>RKT PUPUK - KG NORMAL</div><br>
";
