...
header("Content-Disposition: attachment;Filename=data_rkt_manual_sisip_".date("YmdHis").".xls");
...
// TITLE DOKUMEN
echo "
<div style='font-weight:bolder; font-size:20px;'>RKT RAWAT SISIP</div><br>
";
