...
Versi				: 	1.0.0
Deskripsi			: 	View untuk popup LoV Master Activity Class
Function 			:	
Disusun Oleh		: 	IT Support Application - PT Triputra Agro Persada	
Developer			: 	Sabrina Ingrid Davita
Dibuat Tanggal		: 	10/06/2013
Update Terakhir		:	10/06/2013
Revisi				:	
=========================================================================================================================
*/
...
$(document).ready(function() {
	$("#table1 tr input[id^=pick]").live("click", function() {
		...
		//norma harga borong
		if(module == 'normaHargaBorong'){
			opener.$("#text06_" + row).val(arr[1]);
		} else if(module == 'rktManualNonInfra'){
