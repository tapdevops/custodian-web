		...
		<fieldset>
			...
			<thead>
				<tr name='content' id='content'>
					...
					<th>DISTRIBUSI HA KERJA<BR>DEC</th>
			...
			<tbody name='data' id='data'>
				<tr name='content' id='content' style="display:none;" >
					...
					<td width='75px'><input type="text" name="text29[]" id="text29_" readonly="readonly" /></td>
					...
					<td width='100px'>
					<input type="hidden" name="text27[]" id="text27_" readonly="readonly" value='27'/>	
					<input type="text" name="text26[]" id="text26_" readonly="readonly" value='26'/></td>
			...
			<tfoot name='tfoot' id='tfoot' style="display:none">
				<tr>
					...
					<td width='50px'>&nbsp;</td>
					<td width='50px'>&nbsp;</td>
					<td width='100px'><input type="text" name="total11" id="total11" readonly="readonly" value='11'/></td>
					<td width='100px'><input type="text" name="total12" id="total12" readonly="readonly" value='12'/></td>
					<td width='100px'><input type="text" name="total13" id="total13" readonly="readonly" value='13'/></td>
					<td width='100px'><input type="text" name="total14" id="total14" readonly="readonly" value='14'/></td>
					<td width='100px'><input type="text" name="total15" id="total15" readonly="readonly" value='15'/></td>
					<td width='100px'><input type="text" name="total16" id="total16" readonly="readonly" value='16'/></td>
					<td width='100px'><input type="text" name="total17" id="total17" readonly="readonly" value='17'/></td>
					<td width='100px'><input type="text" name="total18" id="total18" readonly="readonly" value='18'/></td>
					<td width='100px'><input type="text" name="total19" id="total19" readonly="readonly" value='19'/></td>
					<td width='100px'><input type="text" name="total20" id="total20" readonly="readonly" value='20'/></td>
					<td width='100px'><input type="text" name="total21" id="total21" readonly="readonly" value='21'/></td>
					<td width='100px'><input type="text" name="total22" id="total22" readonly="readonly" value='22'/></td>
					<td width='100px'><input type="text" name="total23" id="total23" readonly="readonly" value='23'/></td>
					<td width='100px'><input type="text" name="total24" id="total24" readonly="readonly" value='24'/></td>
					<td width='100px'><input type="text" name="total25" id="total25" readonly="readonly" value='25'/></td>
					<td width='100px'><input type="text" name="total26" id="total26" readonly="readonly" value='26'/></td>
				</tr>
			</tfoot>
			-->
			</table>
...
$(document).ready(function() {
	...
	$("#btn_find").click(function() {
		...
		var src_matstage_code = $("#src_matstage_code").val();	//SEARCH MATURITY STAGE
		...
		if ( ( reference_role == 'BA_CODE' ) && ( region == '' ) && ( ba_code == '' ) ) {
			...
			$.ajax({
				type     : "post",
				url      : "rkt-pupuk-ha/get-status-periode",
	...
	$("#btn_export_csv").live("click", function() {
		...
		if ( ( reference_role == 'BA_CODE' ) && ( region == '' ) && ( ba_code == '' ) ) {
			...
			window.open("<?=$_SERVER['PHP_SELF']?>/download/data-rkt-pupuk-ha/budgetperiod/" + budgetperiod + "/src_region_code/" + src_region_code + "/key_find/" + key_find + "/src_matstage_code/" + src_matstage_code + "/src_afd/" + src_afd + "/search/" + encode64(search),'_blank');
		}
    });	
...
function getData(){
    ...
    $.ajax({
        ...
        success : function(data) {
            ...
            if (count > 0) {
				$.each(data.rows, function(key, row) {//left freeze panes
					...
					$("#data_freeze tr:eq(" + index + ") input[id^=text29_]").val(row.BLOCK_CODE+ " - " +row.BLOCK_DESC);
					...
					$("#data tr:eq(" + index + ") input[id^=text27_]").val(accounting.formatNumber(row.TRX_RKT_CODE, 2));
					$("#data tr:eq(" + index + ")").removeAttr("style");					
                    $("#data tr:eq(1) input[id^=text02_]").focus();		

					//perhitungan total
					YEAR = (row.YEAR) ? YEAR + parseFloat(row.YEAR) : YEAR;
