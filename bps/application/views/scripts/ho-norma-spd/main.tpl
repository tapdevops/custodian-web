		...
		<fieldset>
			...
			<thead>
				<tr>
					...
					<th>DARI</th>
					<th>KE</th>
					<th colspan="3">PESAWAT TERBANG</th>
					<th colspan="3">Taksi Jkt</th>
					<th colspan="3">Charter</th>
					<th colspan="3">Kendaraan Air</th>
					<th>TOTAL</th>
				</tr>
				<tr>
					<th></th>
			...
			<tbody name='data' id='data'>
				<tr style="display:none">
					...
					<td><input type="text" name="text06[]" id="text06_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text07_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text08_" readonly="readonly" style='width:50px;'/></td>
					<td><input type="text" name="text06[]" id="text09_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text10_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text11_" readonly="readonly" style='width:50px;'/></td>
					<td><input type="text" name="text06[]" id="text12_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text13_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text14_" readonly="readonly" style='width:50px;'/></td>
					<td><input type="text" name="text06[]" id="text15_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text16_" readonly="readonly" class="number" style='width:100px;'/></td>
					<td><input type="text" name="text06[]" id="text17_" readonly="readonly" class="number" style='width:100px;'/></td>
				</tr>
			</tbody>
			</table>
			</div>
        ...
        success : function(data) {
            ...
            if (count > 0) {
                $.each(data.rows, function(key, row) {
                    ...
                    $("#data tr:eq(" + index + ") input[id^=text02_]").val(row.RUTE);
                    $("#data tr:eq(" + index + ") input[id^=text03_]").val(row.DARI);
                    $("#data tr:eq(" + index + ") input[id^=text04_]").val(row.TUJUAN);
                    $("#data tr:eq(" + index + ") input[id^=text05_]").val(row.PLANE_QTY);
					$("#data tr:eq(" + index + ") input[id^=text06_]").val(accounting.formatNumber(row.PLANE_N_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text07_]").val(accounting.formatNumber(row.PLANE_P_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text08_]").val(row.TAXI_QTY);
					$("#data tr:eq(" + index + ") input[id^=text09_]").val(accounting.formatNumber(row.TAXI_N_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text10_]").val(accounting.formatNumber(row.TAXI_P_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text11_]").val(row.CHARTER_QTY);
					$("#data tr:eq(" + index + ") input[id^=text12_]").val(accounting.formatNumber(row.CHARTER_N_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text13_]").val(accounting.formatNumber(row.CHARTER_P_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text14_]").val(row.WATER_VEH_QTY);
					$("#data tr:eq(" + index + ") input[id^=text15_]").val(accounting.formatNumber(row.WATER_VEH_N_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text16_]").val(accounting.formatNumber(row.WATER_VEH_P_PRICE, 2));
					$("#data tr:eq(" + index + ") input[id^=text17_]").val(accounting.formatNumber(row.TOTAL_PRICE, 2));
