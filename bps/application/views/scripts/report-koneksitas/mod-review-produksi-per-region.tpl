...
header("Content-Disposition: attachment;Filename=mod_review_produksi_region_".date("YmdHis").".xls");
...
<div style='font-weight:bolder; font-size:12px;'>PERIODE : ".date('Y', strtotime($this->data['rows'][0]['PERIOD_BUDGET']))."</div><br>
<table border=1>
