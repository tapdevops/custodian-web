...
=========================================================================================================================
*/
class HoRencanaKerjaController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_HoRencanaKerja();
    ...
    {
        $this->_redirect('/ho-rencana-kerja/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Budgeting HO &raquo; Rencana Kerja';
    ...
    {		
        ...
        $data['locked'] = $this->_model->getStatusLock($params);
	...
	public function mappingAction(){
        ...
        foreach ($params['text00'] as $key => $val) {
        	...
        	if ($params['tChange'][$key]) {
				...
				$rows[$key]['RK_NAME'] 			= $params['text04'][$key];
				$rows[$key]['RK_DESCRIPTION'] 	= $params['text05'][$key];
	...
	public function saveAction()
    {
		...
		if (!empty($rows)) {
			...
			// generate filename untuk .sh dan .sql
			$filename = $uniq_code_file.'_00_HO_RK_01_SAVETEMP';
	...
	public function deleteAction()
    {
		...
		//generate filename untuk .sh dan .sql
		$filename = $uniq_code_file.'_00_HRK_01_DELETE';
		$this->_global->createBashFile($filename); //create bash file			
		$this->_global->createSqlFile($filename, "START : ".date("Y-m-d H:i:s")."\n"); //start create file
