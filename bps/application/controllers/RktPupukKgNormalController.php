...
Versi				: 	1.0.0
Deskripsi			: 	Controller Class untuk RKT Kg Normal
Function 			:	- listAction		: menampilkan list RKT Kg Normal
...
=========================================================================================================================
*/
class RktPupukKgNormalController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_RktPupukKgNormal();
    ...
    {
        $this->_redirect('/rkt-pupuk-kg-normal/main');
    }
	...
	public function saveAllAction()
    {
		...
		$this->_model->calculatePokokPupuk($params);
