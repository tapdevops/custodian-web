...
Versi				: 	2.0.0
Deskripsi			: 	Controller Class untuk RKT Internal Relation
Function 			:	- getStatusPeriodeAction		: BDJ 22/07/2013	: cek status periode budget yang dipilih
						- listAction					: SID 15/07/2013	: menampilkan list RKT IR
...
=========================================================================================================================
*/
class RktInternalRelationController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_RktInternalRelation();
    ...
    {
        $this->_redirect('/rkt-internal-relation/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Budgeting Tahap 2 &raquo; RKT Internal Relation';
		$this->view->period = date("Y", strtotime($this->_period));
		$this->view->referencerole = $this->_model->_referenceRole; // TAMBAHAN : Sabrina - 19/06/2013
    }
	
	//menampilkan list RKT Internal Relation
