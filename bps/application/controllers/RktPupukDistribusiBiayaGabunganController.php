...
Versi				: 	1.0.0
Deskripsi			: 	Controller Class untuk RKT Pupuk Distribusi Biaya Gabungan
Function 			:	- listAction		: menampilkan list RKT Pupuk Distribusi Biaya Gabungan
...
=========================================================================================================================
*/
class RktPupukDistribusiBiayaGabunganController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_RktPupukDistribusiBiayaGabungan();
    ...
    {
        $this->_redirect('/rkt-pupuk-distribusi-biaya-gabungan/main');
    }
    ...
    {
        $this->view->title = 'Report &raquo; Pupuk - Distribusi Biaya Gabungan';
		$this->view->period = date("Y", strtotime($this->_period));
		$this->view->referencerole = $this->_model->_referenceRole; // TAMBAHAN : Sabrina - 19/06/2013
    }
	
	//menampilkan list RKT Pupuk Distribusi Biaya Gabungan
	...
	public function saveAllAction()
    {
		...
		$this->_model->calculateAllItem($params);
