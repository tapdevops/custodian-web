...
=========================================================================================================================
*/
class HoPrebudgetMasterController extends Zend_Controller_Action
{
    ...
    {
        $this->_redirect('/ho-prebudget-master/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Prebudgeting HO &raquo; Master';
	...
	public function masterSettingAction()
    {
        ...
        $table = new Application_Model_HoMasterSetting();
