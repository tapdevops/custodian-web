...
=========================================================================================================================
*/
class HoDivisionController extends Zend_Controller_Action
{
    ...
    public function init()
    {
		...
		$this->_model = new Application_Model_HoDivision();
    }
    ...
    {
        $this->view->title = 'Pengaturan &raquo; Master &raquo; Division';
    ...
    public function mappingAction(){
        ...
        foreach ($params['text00'] as $key => $val) {
            ...
            if ($params['tChange'][$key]) {
                ...
                $rows[$key]['DIV_CODE']         = $params['text03'][$key];
                $rows[$key]['DIV_NAME']         = $params['text04'][$key];
    ...
    public function saveAction()
    {
        ...
        if (!empty($rows)) {
            ...
            $filename = $uniq_code_file.'_00_HO_DIV_01_SAVETEMP';
