...
=========================================================================================================================
*/
class HoCoreController extends Zend_Controller_Action
{
    ...
    public function init()
    {
		...
		$this->_model = new Application_Model_HoCore();
    }

    public function indexAction()
    {
        $this->_redirect('/ho-core/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Pengaturan &raquo; Master &raquo; Core';
    ...
    public function mappingAction(){
        ...
        foreach ($params['text00'] as $key => $val) {
            ...
            if ($params['tChange'][$key]) {
                ...
                $rows[$key]['CORE_CODE']           = $params['text02'][$key];
                $rows[$key]['CORE_NAME'] = $params['text03'][$key];
    ...
    public function saveAction()
    {
        ...
        if (!empty($rows)) {
            ...
            $filename = $uniq_code_file.'_00_HO_CORE_01_SAVETEMP';
