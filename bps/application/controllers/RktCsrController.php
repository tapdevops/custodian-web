...
Versi				: 	2.0.0
Deskripsi			: 	Controller Class untuk RKT CSR
Function 			:	- getStatusPeriodeAction		: BDJ 22/07/2013	: cek status periode budget yang dipilih
						- listAction					: SID 15/07/2013	: menampilkan list RKT CSR
...
=========================================================================================================================
*/
class RktCsrController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_RktCsr();
    ...
    {
        $this->_redirect('/rkt-csr/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Budgeting Tahap 2 &raquo; RKT CSR';
		$this->view->period = date("Y", strtotime($this->_period));
		$this->view->referencerole = $this->_model->_referenceRole; // TAMBAHAN : Sabrina - 19/06/2013
    }
	
	//menampilkan list RKT CSR
