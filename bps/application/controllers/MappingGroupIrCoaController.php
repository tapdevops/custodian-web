...
Versi				: 	1.0.0
Deskripsi			: 	Controller Class untuk Mapping Group Internal Relation - COA
Function 			:	- listAction		: menampilkan list Mapping Group Internal Relation - COA
...
=========================================================================================================================
*/
class MappingGroupIrCoaController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_MappingGroupIrCoa();
    ...
    {
        $this->_redirect('/mapping-group-ir-coa/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Data &raquo; Mapping Group Internal Relation - COA';
		$this->view->period = date("Y", strtotime($this->_period));
		$this->_helper->layout->setLayout('detail');
    }
	
	//menampilkan list Mapping Group Internal Relation - COA
	...
	public function updLockedSeqStatusAction(){
        ...
        $params = $this->_request->getPost();
		$params['task_name'] = "TM_GROUP_RELATION_IR";
