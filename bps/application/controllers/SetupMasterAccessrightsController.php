...
=========================================================================================================================
*/
class SetupMasterAccessrightsController extends Zend_Controller_Action
{
    ...
    {
        $this->_redirect('/setup-master-accessrights/main');
    }
    ...
    public function mainAction()
    {
        ...
        $table = new Application_Model_SetupMasterAccessrights();
