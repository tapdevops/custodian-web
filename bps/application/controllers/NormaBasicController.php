...
=========================================================================================================================
*/
class NormaBasicController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_NormaBasic();
    ...
    {
        $this->_redirect('/norma-dasar/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Data &raquo; Norma Dasar';
