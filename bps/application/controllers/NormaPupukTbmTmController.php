...
=========================================================================================================================
*/
class NormaPupukTbmTmController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_NormaPupukTbmTm();
    ...
    {
        $this->_redirect('/norma-pupuk-tbm-tm/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Data &raquo; Norma Pupuk TM';
