...
Versi				: 	1.0.0
Deskripsi			: 	Controller Class untuk RKT Pupuk Distribusi Biaya Normal
Function 			:	- listAction		: menampilkan list RKT Pupuk Distribusi Biaya Normal
...
=========================================================================================================================
*/
class RktPupukDistribusiBiayaNormalController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_RktPupukDistribusiBiayaNormal();
    ...
    {
        $this->_redirect('/rkt-pupuk-distribusi-biaya-normal/main');
    }
    ...
    {
        $this->view->title = 'Report &raquo; Pupuk - Distribusi Biaya Normal';
		$this->view->period = date("Y", strtotime($this->_period));
		$this->view->referencerole = $this->_model->_referenceRole; // TAMBAHAN : Sabrina - 19/06/2013
    }
	
	//menampilkan list RKT Pupuk Distribusi Biaya Normal
    ...
    $this->_model->calculateLaborNormal($params);
    $this->_model->calculateToolsNormal($params);
    $this->_model->calculateTransportsNormal($params);
    $this->_model->calculateMaterialNormal($params);
