...
=========================================================================================================================
*/
class HoCoaController extends Zend_Controller_Action
{
    ...
    {
        $this->_redirect('/ho-coa/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Pengaturan &raquo; Master &raquo; Coa';
    ...
    public function mappingAction(){
        ...
        foreach ($params['text00'] as $key => $val) {
            ...
            if ($params['tChange'][$key]) {
                ...
                $rows[$key]['COA_CODE']           = $params['text02'][$key];
                $rows[$key]['COA_NAME'] = $params['text03'][$key];
                $rows[$key]['COA_GROUP'] = $params['text04'][$key];
                $rows[$key]['STATUS'] = $params['text05'][$key];
    ...
    public function saveAction()
    {
        ...
        if (!empty($rows)) {
            ...
            $filename = $uniq_code_file.'_00_HO_COA_01_SAVETEMP';
