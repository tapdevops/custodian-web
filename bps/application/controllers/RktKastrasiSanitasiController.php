...
=========================================================================================================================
*/
class RktKastrasiSanitasiController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_RktKastrasiSanitasi();
    ...
    {
        $this->_redirect('/rkt-kastrasi-sanitasi/main');
    }

    public function mainAction()
    {
        $this->view->title = 'Budgeting Tahap 2 &raquo; RKT kastrasi Sanitasi';
	...
	public function mappingAction(){
        ...
        foreach ($params['text00'] as $key => $val) {
            if ($key > 0){
				...
				$rows[$key]['TAHUN_TANAM'] 			= $params['text06'][$key]; // TAHUN_TANAM
				...
				$rows[$key]['TIPE_NORMA']  			= $params['text50'][$key]; // TIPE_NORMA
				...
				$rows[$key]['LAND_SUITABILITY'] 			= $params['hidden02'][$key]; // LAND_SUITABILITY
            }
        }
		return $rows;
	}
	...
	public function saveAction()
    {
		...
		foreach ($rows as $key => $row) {
			...
			$this->_model->updateTempKastrasi($row);
