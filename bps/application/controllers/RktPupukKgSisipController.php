...
Versi				: 	1.0.0
Deskripsi			: 	Controller Class untuk RKT Kg Sisip
...
=========================================================================================================================
*/
class RktPupukKgSisipController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_RktPupukKgSisip();
    ...
    {
        $this->_redirect('/rkt-pupuk-kg-sisip/main');
    }
    ...
    {
        $this->view->title = 'Report &raquo; Pupuk - KG Sisip';
	...
	public function saveAllAction()
    {
		...
		$this->_model->calculateKgSisip($params);
