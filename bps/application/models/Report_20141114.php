		...
		$query = "
			...
			FROM (
				...
				SELECT 	RKT.PERIOD_BUDGET,
						...
						0 QTY_NOV,
						0 QTY_DEC,
						(HS.SMS1_TBM0 / HS.TOTAL_HA_SMS1 * RKT.COST_JAN) AS COST_JAN,
						(HS.SMS1_TBM0 / HS.TOTAL_HA_SMS1 * RKT.COST_FEB) AS COST_FEB,
						(HS.SMS1_TBM0 / HS.TOTAL_HA_SMS1 * RKT.COST_MAR) AS COST_MAR,
						(HS.SMS1_TBM0 / HS.TOTAL_HA_SMS1 * RKT.COST_APR) AS COST_APR,
						(HS.SMS1_TBM0 / HS.TOTAL_HA_SMS1 * RKT.COST_MAY) AS COST_MAY,
						(HS.SMS1_TBM0 / HS.TOTAL_HA_SMS1 * RKT.COST_JUN) AS COST_JUN,
						(HS.SMS2_TBM0 / HS.TOTAL_HA_SMS2 * RKT.COST_JUL) AS COST_JUL,
						(HS.SMS2_TBM0 / HS.TOTAL_HA_SMS2 * RKT.COST_AUG) AS COST_AUG,
						(HS.SMS2_TBM0 / HS.TOTAL_HA_SMS2 * RKT.COST_SEP) AS COST_SEP,
						(HS.SMS2_TBM0 / HS.TOTAL_HA_SMS2 * RKT.COST_OCT) AS COST_OCT,
						(HS.SMS2_TBM0 / HS.TOTAL_HA_SMS2 * RKT.COST_NOV) AS COST_NOV,
						(HS.SMS2_TBM0 / HS.TOTAL_HA_SMS2 * RKT.COST_DEC) AS COST_DEC,
						0 RP_ROTASI_SMS1,
						0 RP_ROTASI_SMS2
				...
				SELECT 	RKT.PERIOD_BUDGET,
						...
						0 QTY_NOV,
						0 QTY_DEC,
						(HS.SMS1_TBM1 / HS.TOTAL_HA_SMS1 * RKT.COST_JAN) AS COST_JAN,
						(HS.SMS1_TBM1 / HS.TOTAL_HA_SMS1 * RKT.COST_FEB) AS COST_FEB,
						(HS.SMS1_TBM1 / HS.TOTAL_HA_SMS1 * RKT.COST_MAR) AS COST_MAR,
						(HS.SMS1_TBM1 / HS.TOTAL_HA_SMS1 * RKT.COST_APR) AS COST_APR,
						(HS.SMS1_TBM1 / HS.TOTAL_HA_SMS1 * RKT.COST_MAY) AS COST_MAY,
						(HS.SMS1_TBM1 / HS.TOTAL_HA_SMS1 * RKT.COST_JUN) AS COST_JUN,
						(HS.SMS2_TBM1 / HS.TOTAL_HA_SMS2 * RKT.COST_JUL) AS COST_JUL,
						(HS.SMS2_TBM1 / HS.TOTAL_HA_SMS2 * RKT.COST_AUG) AS COST_AUG,
						(HS.SMS2_TBM1 / HS.TOTAL_HA_SMS2 * RKT.COST_SEP) AS COST_SEP,
						(HS.SMS2_TBM1 / HS.TOTAL_HA_SMS2 * RKT.COST_OCT) AS COST_OCT,
						(HS.SMS2_TBM1 / HS.TOTAL_HA_SMS2 * RKT.COST_NOV) AS COST_NOV,
						(HS.SMS2_TBM1 / HS.TOTAL_HA_SMS2 * RKT.COST_DEC) AS COST_DEC,
						0 RP_ROTASI_SMS1,
						0 RP_ROTASI_SMS2
				FROM V_TOTAL_RELATION_COST RKT
				LEFT JOIN (
				...
				SELECT 	RKT.PERIOD_BUDGET,
						...
						0 QTY_NOV,
						0 QTY_DEC,
						(HS.SMS1_TBM2 / HS.TOTAL_HA_SMS1 * RKT.COST_JAN) AS COST_JAN,
						(HS.SMS1_TBM2 / HS.TOTAL_HA_SMS1 * RKT.COST_FEB) AS COST_FEB,
						(HS.SMS1_TBM2 / HS.TOTAL_HA_SMS1 * RKT.COST_MAR) AS COST_MAR,
						(HS.SMS1_TBM2 / HS.TOTAL_HA_SMS1 * RKT.COST_APR) AS COST_APR,
						(HS.SMS1_TBM2 / HS.TOTAL_HA_SMS1 * RKT.COST_MAY) AS COST_MAY,
						(HS.SMS1_TBM2 / HS.TOTAL_HA_SMS1 * RKT.COST_JUN) AS COST_JUN,
						(HS.SMS2_TBM2 / HS.TOTAL_HA_SMS2 * RKT.COST_JUL) AS COST_JUL,
						(HS.SMS2_TBM2 / HS.TOTAL_HA_SMS2 * RKT.COST_AUG) AS COST_AUG,
						(HS.SMS2_TBM2 / HS.TOTAL_HA_SMS2 * RKT.COST_SEP) AS COST_SEP,
						(HS.SMS2_TBM2 / HS.TOTAL_HA_SMS2 * RKT.COST_OCT) AS COST_OCT,
						(HS.SMS2_TBM2 / HS.TOTAL_HA_SMS2 * RKT.COST_NOV) AS COST_NOV,
						(HS.SMS2_TBM2 / HS.TOTAL_HA_SMS2 * RKT.COST_DEC) AS COST_DEC,
						0 RP_ROTASI_SMS1,
						0 RP_ROTASI_SMS2
				FROM V_TOTAL_RELATION_COST RKT
				LEFT JOIN (
				...
				SELECT 	RKT.PERIOD_BUDGET,
						...
						0 QTY_NOV,
						0 QTY_DEC,
						(HS.SMS1_TBM3 / HS.TOTAL_HA_SMS1 * RKT.COST_JAN) AS COST_JAN,
						(HS.SMS1_TBM3 / HS.TOTAL_HA_SMS1 * RKT.COST_FEB) AS COST_FEB,
						(HS.SMS1_TBM3 / HS.TOTAL_HA_SMS1 * RKT.COST_MAR) AS COST_MAR,
						(HS.SMS1_TBM3 / HS.TOTAL_HA_SMS1 * RKT.COST_APR) AS COST_APR,
						(HS.SMS1_TBM3 / HS.TOTAL_HA_SMS1 * RKT.COST_MAY) AS COST_MAY,
						(HS.SMS1_TBM3 / HS.TOTAL_HA_SMS1 * RKT.COST_JUN) AS COST_JUN,
						(HS.SMS2_TBM3 / HS.TOTAL_HA_SMS2 * RKT.COST_JUL) AS COST_JUL,
						(HS.SMS2_TBM3 / HS.TOTAL_HA_SMS2 * RKT.COST_AUG) AS COST_AUG,
						(HS.SMS2_TBM3 / HS.TOTAL_HA_SMS2 * RKT.COST_SEP) AS COST_SEP,
						(HS.SMS2_TBM3 / HS.TOTAL_HA_SMS2 * RKT.COST_OCT) AS COST_OCT,
						(HS.SMS2_TBM3 / HS.TOTAL_HA_SMS2 * RKT.COST_NOV) AS COST_NOV,
						(HS.SMS2_TBM3 / HS.TOTAL_HA_SMS2 * RKT.COST_DEC) AS COST_DEC,
						0 RP_ROTASI_SMS1,
						0 RP_ROTASI_SMS2
				FROM V_TOTAL_RELATION_COST RKT
				LEFT JOIN (
		...
		$query = "
			...
			FROM (
				...
				WHERE RKT.DELETE_USER IS NULL
					...
					$where
				UNION ALL	
				-- BIAYA UMUM + RELATION (SELAIN COA 1212010101) UNTUK TM
				SELECT	RKT.PERIOD_BUDGET,
						ORG.REGION_CODE,
						RKT.BA_CODE,
						'TM' AS TIPE_TRANSAKSI,
						...
						0 QTY_NOV,
						0 QTY_DEC,
						(HS.SMS1_TM / HS.TOTAL_HA_SMS1 * RKT.COST_JAN) AS COST_JAN,
						(HS.SMS1_TM / HS.TOTAL_HA_SMS1 * RKT.COST_FEB) AS COST_FEB,
						(HS.SMS1_TM / HS.TOTAL_HA_SMS1 * RKT.COST_MAR) AS COST_MAR,
						(HS.SMS1_TM / HS.TOTAL_HA_SMS1 * RKT.COST_APR) AS COST_APR,
						(HS.SMS1_TM / HS.TOTAL_HA_SMS1 * RKT.COST_MAY) AS COST_MAY,
						(HS.SMS1_TM / HS.TOTAL_HA_SMS1 * RKT.COST_JUN) AS COST_JUN,
						(HS.SMS2_TM / HS.TOTAL_HA_SMS2 * RKT.COST_JUL) AS COST_JUL,
						(HS.SMS2_TM / HS.TOTAL_HA_SMS2 * RKT.COST_AUG) AS COST_AUG,
						(HS.SMS2_TM / HS.TOTAL_HA_SMS2 * RKT.COST_SEP) AS COST_SEP,
						(HS.SMS2_TM / HS.TOTAL_HA_SMS2 * RKT.COST_OCT) AS COST_OCT,
						(HS.SMS2_TM / HS.TOTAL_HA_SMS2 * RKT.COST_NOV) AS COST_NOV,
						(HS.SMS2_TM / HS.TOTAL_HA_SMS2 * RKT.COST_DEC) AS COST_DEC,
						0 RP_ROTASI_SMS1,
						0 RP_ROTASI_SMS2
				FROM V_TOTAL_RELATION_COST RKT
				LEFT JOIN (
				...
				LEFT JOIN TM_MATERIAL MATERIAL
					...
					AND MATERIAL.COA_CODE = '5101020400' -- UNTUK PUPUK  MAJEMUK
				UNION ALL	
				...
				LEFT JOIN TM_MATERIAL MATERIAL
					...
					AND NORMA_PUPUK.MATERIAL_CODE = MATERIAL.MATERIAL_CODE
					AND MATERIAL.DELETE_USER IS NULL
					AND MATERIAL.COA_CODE = '5101020300' -- UNTUK PUPUK  TUNGGAL
				UNION ALL	
				...
				SELECT 	RKT.PERIOD_BUDGET,
						...
						RKT.BA_CODE,
						'TM' AS TIPE_TRANSAKSI,
						'5101030404' AS ACTIVITY_CODE, -- BY ADI 30/08/2014
				...
				SELECT 	RKT.PERIOD_BUDGET,
						...
						RKT.BA_CODE,
						'TM' AS TIPE_TRANSAKSI,
						'5101030504' AS ACTIVITY_CODE, -- BY ADI 30/08/2014
						'TRANSPORT TBS INTERNAL' AS ACTIVITY_DETAIL,
						'' AS COST_ELEMENT,
						'' KETERANGAN,
						'' AS UOM,
						0 QTY_JAN,
				...
				SELECT 	ANGKUT.PERIOD_BUDGET,
						...
						ANGKUT.BA_CODE,
						'TM' AS TIPE_TRANSAKSI,
						'5101030504' AS ACTIVITY_CODE,
						'PENGANGKUTAN INTERNAL TBS' AS ACTIVITY_DETAIL,
						'' AS COST_ELEMENT,
						'' KETERANGAN,
						'' AS UOM,
						0 QTY_JAN,
