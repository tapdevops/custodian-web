      ...
      --SMS1
          ...
          FROM (
            SELECT 
              ...
              0 QTY_NOV,
              0 QTY_DEC,
              COST_JAN / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_JAN,
              COST_FEB / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_FEB,
              COST_MAR / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_MAR,
              COST_APR / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_APR,
              COST_MAY / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_MAY,
              COST_JUN / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_JUN,
              COST_JUL / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_JUL,
              COST_AUG / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_AUG,
              COST_SEP / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_SEP,
              COST_OCT / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_OCT,
              COST_NOV / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_NOV,
              COST_DEC / (SELECT COUNT(AFD_CODE) TOTAL FROM TR_RKT_COST_ELEMENT
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$period_budget."'
                AND BA_CODE = '".$ba_code."' AND AFD_CODE = RKT.AFD_CODE
                AND ACTIVITY_CODE = '51110' AND COST_ELEMENT = 'TRANSPORT'
                AND MATURITY_STAGE_SMS1 = 'TM') COST_DEC      
              FROM 
              (SELECT PERIOD_BUDGET,
               REGION_CODE,
               BA_CODE,
        ...
        AND UPPER(norma.BA_CODE) LIKE UPPER('%".$ba_code."%')
          ...
          GROUP BY PERIOD_BUDGET,
               ...
               KETERANGAN,
               UOM) AJK
LEFT JOIN TR_RKT_COST_ELEMENT RKT
    ON RKT.PERIOD_BUDGET = AJK.PERIOD_BUDGET
    AND RKT.BA_CODE = AJK.BA_CODE
    AND RKT.AFD_CODE = AJK.AFD_CODE
    AND RKT.ACTIVITY_CODE = AJK.ACTIVITY_CODE
    AND RKT.COST_ELEMENT = AJK.COST_ELEMENT
LEFT JOIN TM_ACTIVITY ACT 
    ON ACT.ACTIVITY_CODE = RKT.ACTIVITY_CODE
LEFT JOIN TM_ORGANIZATION ORG 
    ON ORG.BA_CODE = RKT.BA_CODE
...
LEFT JOIN TM_VRA VRA 
    ON VRA.VRA_CODE = RKT_DIS_SUM.VRA_CODE
WHERE RKT.MATURITY_STAGE_SMS1 = 'TM'
ORDER BY RKT.AFD_CODE )    
  ...
  -- INI UNTUK PERHITUNGAN SUPERVISI  5101030701 BONGKAR MUAT LABOUR
           ...
           LEFT JOIN (  
              /*SELECT HS.PERIOD_BUDGET,
                ...
                SELECT 
                    HS.PERIOD_BUDGET,
                    HS.BA_CODE,
                    SUMHA_BA.TOTAL_SMS1_TM TOTAL_HA_SMS1,
                    SUMHA_BA.TOTAL_SMS2_TM TOTAL_HA_SMS2
                ...
                ON SUMHA_BA.PERIOD_BUDGET = HS.PERIOD_BUDGET
                AND SUMHA_BA.BA_CODE = HS.BA_CODE
                WHERE HS.BA_CODE = SUMHA_BA.BA_CODE 
                AND HS.PERIOD_BUDGET = SUMHA_BA.PERIOD_BUDGET
                --AND to_char(HS.PERIOD_BUDGET,'RRRR') = '2018'
                --AND HS.BA_CODE = '2121'
                GROUP BY 
                  HS.PERIOD_BUDGET, 
                  HS.BA_CODE, 
                  SUMHA_BA.TOTAL_SMS1_TM, 
                  SUMHA_BA.TOTAL_SMS2_TM
              ) HS2
    ...
    /*if ($this->_db->commit()) {
      echo '1 - ' . $query;
        ...
        SELECT
          ...
          (SEBARAN.NOV * RKT.TUKANG_MUAT_TOTAL) AS COST_NOV,
          (SEBARAN.DEC * RKT.TUKANG_MUAT_TOTAL) AS COST_DEC,
          '".$this->_userName."' AS INSERT_USER, CURRENT_TIMESTAMP AS INSERT_TIME
        FROM TR_RKT_PANEN RKT
        LEFT JOIN(
            SELECT
              PERIOD_BUDGET,
    ...
    $components['langsir_labour'] = "
      ...
      SELECT
        ...
        0 QTY_NOV,
        0 QTY_DEC,
        SUM(COST_JAN) COST_JAN, SUM(COST_FEB) COST_FEB, SUM(COST_MAR) COST_MAR, 
        SUM(COST_APR) COST_APR, SUM(COST_MAY) COST_MAY, SUM(COST_JUN) COST_JUN,
        SUM(COST_JUL) COST_JUL, SUM(COST_AUG) COST_AUG, SUM(COST_SEP) COST_SEP, 
        SUM(COST_OCT) COST_OCT, SUM(COST_NOV) COST_NOV, SUM(COST_DEC) COST_DEC,
        0 QTY_SETAHUN,
  ...
  /*$components['astek'] = "
    SELECT
      ...
      'NICHOLAS.BUDIHARDJA' AS INSERT_USER,
    ...
    FROM (
      SELECT
        ...
        HA_TM.AFD_CODE,
        --HA_TM.BLOCK_CODE,
        --HA_TM.TIPE_TRANSAKSI, 
        TTL_COST.TUNJANGAN_TYPE,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1*TTL_COST.MPP) AS QTY_JAN,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1*TTL_COST.MPP) AS QTY_FEB,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1*TTL_COST.MPP) AS QTY_MAR,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1*TTL_COST.MPP) AS QTY_APR,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1*TTL_COST.MPP) AS QTY_MAY,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1*TTL_COST.MPP) AS QTY_JUN,
        0 as QTY_JUL, 0 as QTY_AUG, 0 as QTY_SEP, 0 as QTY_OCT, 0 as QTY_NOV, 0 as QTY_DEC,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1 * RKT.DIS_JAN) COST_JAN,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1 * RKT.DIS_FEB) COST_FEB,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1 * RKT.DIS_MAR) COST_MAR,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1 * RKT.DIS_APR) COST_APR,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1 * RKT.DIS_MAY) COST_MAY,
        (HA_TM.HA_AFD_1 / HA_TM.HA_BA_1 * RKT.DIS_JUN) COST_JUN,
      ...
      LEFT JOIN TR_RPT_DISTRIBUSI_COA RKT
          ON HA_TM.PERIOD_BUDGET = RKT.PERIOD_BUDGET
          AND HA_TM.BA_CODE = RKT.BA_CODE      
      ...
      LEFT JOIN(
        ...
        FROM (
          ...
          WHERE CR.DELETE_TIME IS NULL AND CR.BA_CODE = '".$params['key_find']."'
          AND EXTRACT(YEAR FROM CR.PERIOD_BUDGET) = '".$params['budgetperiod']."'
          AND CD.TUNJANGAN_TYPE IN ('ASTEK')
          ORDER BY 2
        ) S WHERE JOB_TYPE = 'OT'
      ...
      WHERE EXTRACT(YEAR FROM HA_TM.PERIOD_BUDGET) = '".$params['budgetperiod']."' 
      AND HA_TM.BA_CODE = '".$params['key_find']."'
      AND RKT.REPORT_TYPE = 'CR_ALOKASI'
          AND RKT.DELETE_USER IS NULL
          AND RKT.TUNJANGAN_TYPE IN ('ASTEK')
    ...
    SELECT
        ...
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2*TTL_COST.MPP) AS QTY_JUL,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2*TTL_COST.MPP) AS QTY_AUG,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2*TTL_COST.MPP) AS QTY_SEP,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2*TTL_COST.MPP) AS QTY_OCT,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2*TTL_COST.MPP) AS QTY_NOV,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2*TTL_COST.MPP) AS QTY_DEC,
        0 as COST_JAN, 0 as COST_FEB, 0 as COST_MAR, 0 as COST_APR, 0 as COST_MAY, 0 as COST_JUN,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2 * RKT.DIS_JUL) AS COST_JUL,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2 * RKT.DIS_AUG) AS COST_AUG,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2 * RKT.DIS_SEP) COST_SEP,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2 * RKT.DIS_OCT) COST_OCT,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2 * RKT.DIS_NOV) COST_NOV,
        (HA_TM.HA_AFD_2 / HA_TM.HA_BA_2 * RKT.DIS_DEC) COST_DEC
      FROM (
         SELECT SUMHA_AFD.PERIOD_BUDGET,
                  SUMHA_AFD.BA_CODE,
                  SUMHA_AFD.AFD_CODE,
    ...
    GROUP BY PERIOD_BUDGET, REGION_CODE, BA_CODE, TUNJANGAN_TYPE
  ";*/

    $components['hektar_tm'] = "
      INSERT INTO TMP_RPT_KEB_EST_COST_BLOCK (
      PERIOD_BUDGET,
      REGION_CODE,
      BA_CODE,
      ...
      FROM (
        ...
        WHERE RKT.DELETE_USER IS NULL 
          ...
          AND EXTRACT(YEAR FROM RKT.PERIOD_BUDGET) = '".$params['budgetperiod']."' 
          AND RKT.BA_CODE = '".$params['key_find']."'
) group by PERIOD_BUDGET, REGION_CODE, BA_CODE, AFD_CODE, BLOCK_CODE, TIPE_TRANSAKSI, ACTIVITY_CODE, 
ACTIVITY_DESC, COST_ELEMENT, SUB_COST_ELEMENT_DESC, KETERANGAN, UOM
    ";

    $components['produksi_tbs'] = "
      INSERT INTO TMP_RPT_KEB_EST_COST_BLOCK (
      PERIOD_BUDGET,
      REGION_CODE,
      BA_CODE,
...
ACTIVITY_DESC, COST_ELEMENT, SUB_COST_ELEMENT_DESC, KETERANGAN, UOM
  ...
  foreach ($components as $key => $sql_string) {
    ...
    $this->_db->commit();
    /*if ($this->_db->commit()) {
      echo $a . ' - components - ' . $key . '<BR />' . ' - ' . $sql_string; 
    }*/
    $a++;
  }
 ...
 WHERE     RKT.COA_CODE = '43800'
   ...
   --ini untuk PUPUK MAJEMUK TOOLS
    ...
    $devcost_components['kastrasi_sanitasi'] = "
      ...
      PIVOT (
        SUM(QTY*HA_PLANTED) AS DIS, SUM(QTY*PRICE*HA_PLANTED) AS COST
        FOR BULAN_ROTASI IN (
          '1' AS JAN, '2' AS FEB, '3' AS MAR, '4' AS APR, '5' AS MAY, '6' AS JUN,
          '7' AS JUL, '8' AS AUG, '9' AS SEP, '10' AS OCT, '11' AS NOV, '12' AS DEC
        )
    ...
    /*$devcost_components['AJK_PEMANEN'] = "
      INSERT INTO TMP_RPT_KEB_DEV_COST_BLOCK (
        PERIOD_BUDGET,
        REGION_CODE,
        BA_CODE,
    ...
    foreach ($devcost_components as $key => $sql_string) {
      ...
      $this->_db->commit();
      /*if ($this->_db->commit()) {
        echo $i . ' - devcost_components - ' . $key . ' - ' . $sql_string;
      }*/
      $i++;
    }
    ...
    foreach ($salary_components as $key) {
      ...
      $this->_db->commit();
      /*if ($this->_db->commit()) {
        echo $j . ' - salary_components - ' . $key . ' - ' . $sql_string; 
      }*/
      $j++;
    }
