...
=========================================================================================================================
*/
class Application_Model_HoMasterSetting
{
    private $_db = null;
	...
	public function getList($params = array())
    {
        ...
        foreach ($rows as $idx => $row) {
            ...
            $sinkron = '<input type="button" name="sinkron[]" id="sinkron_'.$cRow.'_{item_name}" value="Sinkronisasi" title="Sinkronisasi" class="button">';
            ...
            foreach ($row as $key => $val) {
                if ($key == 0 || $key == 2 || $key == 4) {
                    ...
                    //print_r ($val); echo '<br />';
                    /*if ($val == 'ho-division/main' || $val == 'ho-company/main') {
                        $data[] = str_replace('{item_name}', $val, $sinkron) . 
