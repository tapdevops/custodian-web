...
class Application_Model_NormaInsentivePanen
{
  ...
  { 
    ...
    $sql = "
      ...
      SET  
        PERCENTAGE_INCENTIVE_1 = REPLACE('".$row['PERCENTAGE_INCENTIVE_1']."', ',', ''),
        INCENTIVE_1 = REPLACE('".$row['INCENTIVE_1']."', ',', ''),
        PERCENTAGE_INCENTIVE_2 = REPLACE('".$row['PERCENTAGE_INCENTIVE_2']."', ',', ''),
        INCENTIVE_2 = REPLACE('".$row['INCENTIVE_2']."', ',', ''),
        PERCENTAGE_INCENTIVE_3 = REPLACE('".$row['PERCENTAGE_INCENTIVE_3']."', ',', ''),
        INCENTIVE_3 = REPLACE('".$row['INCENTIVE_3']."', ',', ''),
