...
3     NBU       08-05-2015          Pemisahan perhitungan premi janjang dan premi brd
4	  NBU		  10-01-2018		  PERUBAHAN PERHITUNGAN UNTUK GANTI BAN LUAR DAN BAN DALAM
...
class Application_Model_Formula
{
  ...
  //check popok lebih atau tidak
  public function cal_Upload_Sph1($params = array())
    {
    $jumlah_pokok = (float)str_replace(",", "", $params['POKOK_TANAM']);
    $total_ha = (float)str_replace(",", "", $params['HA_PLANTED']);
  ...
  public function cal_NormaCheckroll_Tunjangan($params = array())
    ...
    if (count($rows) > 0) {
      ...
      */
      ...
      //if ((addslashes($params['BA_CODE']) == '3121') && (addslashes($params['JOB_CODE']) == 'FW030') && (addslashes($params['EMPLOYEE_STATUS']) == 'KL')) {     
      //  die($sql);    
      //}
      ...
      */
      ...
      if (count($rows) > 0) {
        ...
        foreach ($rumus as $idx => $rumus_hitung) {
          ...
          //edited by Aries disuruh yus THR harus ikut kehitung 10.10.2016 
          //if ( ( $idx == 'THR' || $idx == 'BONUS' ) && ( $params['EMPLOYEE_STATUS'] <> 'KT') ) {
          if ( ($idx == 'BONUS' ) && ( $params['EMPLOYEE_STATUS'] <> 'KT') ) {
            $a[] = $idx;
            $result[$idx] = 0;
  ...
  public function cal_RktVra_PerincianRvra($params = array())
    ...
    //FUEL / BAHAN BAKAR
    $result['RVRA2_VALUE1'] = isset($rvra['qty_uom']['R550101030101']) ? $rvra['qty_uom']['R550101030101'] : 0;
    $result['RVRA2_VALUE2'] = isset($rvra['qty_uom']['R550101030101']) ? $rvra['harga']['R550101030101'] : 0;
    $result['RVRA2_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101030101'])) ? ($result['RVRA2_VALUE1'] * $result['RVRA2_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA2_VALUE3'];
    $total_biaya2 += ($result['RVRA2_VALUE1'] * $result['RVRA2_VALUE2'] * $total_qty_tahun );
    
    //OLI MESIN
    $result['RVRA3_VALUE1'] = isset($rvra['qty_uom']['R550101040101']) ? $rvra['qty_uom']['R550101040101'] : 0;
    $result['RVRA3_VALUE2'] = isset($rvra['qty_uom']['R550101040101']) ? $rvra['harga']['R550101040101'] : 0;
    $result['RVRA3_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101040101'])) ? ($result['RVRA3_VALUE1'] * $result['RVRA3_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA3_VALUE3'];
    $total_biaya2 += ($result['RVRA3_VALUE1'] * $result['RVRA3_VALUE2']* $total_qty_tahun );
    
    //OLI TRANSMISI
    $result['RVRA4_VALUE1'] = isset($rvra['qty_uom']['R550101040102']) ? $rvra['qty_uom']['R550101040102'] : 0;
    $result['RVRA4_VALUE2'] = isset($rvra['qty_uom']['R550101040102']) ? $rvra['harga']['R550101040102'] : 0;
    $result['RVRA4_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101040102'])) ? ($result['RVRA4_VALUE1'] * $result['RVRA4_VALUE2'])  : 0;
    $total_rp_qty += $result['RVRA4_VALUE3'];
    $total_biaya2 += ($result['RVRA4_VALUE1'] * $result['RVRA4_VALUE2']* $total_qty_tahun );
    
    //MINYAK HYDROLIC
    $result['RVRA5_VALUE1'] = isset($rvra['qty_uom']['R550101040103']) ? $rvra['qty_uom']['R550101040103'] : 0;
    $result['RVRA5_VALUE2'] = isset($rvra['qty_uom']['R550101040103']) ? $rvra['harga']['R550101040103'] : 0;
    $result['RVRA5_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101040103'])) ? ($result['RVRA5_VALUE1'] * $result['RVRA5_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA5_VALUE3'];
    $total_biaya2 += ($result['RVRA5_VALUE1'] * $result['RVRA5_VALUE2']* $total_qty_tahun );
    
    //GREASE
    $result['RVRA6_VALUE1'] = isset($rvra['qty_uom']['R550101040104']) ? $rvra['qty_uom']['R550101040104'] : 0;
    $result['RVRA6_VALUE2'] = isset($rvra['qty_uom']['R550101040104']) ? $rvra['harga']['R550101040104'] : 0;
    $result['RVRA6_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101040104'])) ? ($result['RVRA6_VALUE1'] * $result['RVRA6_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA6_VALUE3'];
    $total_biaya2 += ($result['RVRA6_VALUE1'] * $result['RVRA6_VALUE2']* $total_qty_tahun );
    
    //FILTER OLI
    $result['RVRA7_VALUE1'] = isset($rvra['qty_uom']['R550101050101']) ? $rvra['qty_uom']['R550101050101'] : 0;
    $result['RVRA7_VALUE2'] = isset($rvra['qty_uom']['R550101050101']) ? $rvra['harga']['R550101050101'] : 0;
    $result['RVRA7_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101050101'])) ? ($result['RVRA7_VALUE1'] * $result['RVRA7_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA7_VALUE3'];
    $total_biaya2 += ($result['RVRA7_VALUE1'] * $result['RVRA7_VALUE2']* $total_qty_tahun );
    
    //FILTER HYDROLIC
    $result['RVRA8_VALUE1'] = isset($rvra['qty_uom']['R550101050102']) ? $rvra['qty_uom']['R550101050102'] : 0;
    $result['RVRA8_VALUE2'] = isset($rvra['qty_uom']['R550101050102']) ? $rvra['harga']['R550101050102'] : 0;
    $result['RVRA8_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101050102'])) ? ($result['RVRA8_VALUE1'] * $result['RVRA8_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA8_VALUE3'];
    $total_biaya2 += ($result['RVRA8_VALUE1'] * $result['RVRA8_VALUE2']* $total_qty_tahun );
    
    //FILTER SOLAR
    $result['RVRA9_VALUE1'] = isset($rvra['qty_uom']['R550101050103']) ? $rvra['qty_uom']['R550101050103'] : 0;
    $result['RVRA9_VALUE2'] = isset($rvra['qty_uom']['R550101050103']) ? $rvra['harga']['R550101050103'] : 0;
    $result['RVRA9_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101050103'])) ? ($result['RVRA9_VALUE1'] * $result['RVRA9_VALUE2']) : 0;
    ...
    $result['RVRA10_VALUE1'] = isset($rvra['qty_uom']['R550101050104']) ? $rvra['qty_uom']['R550101050104'] : 0;
    $result['RVRA10_VALUE2'] = isset($rvra['qty_uom']['R550101050104']) ? $rvra['harga']['R550101050104'] : 0;
    $result['RVRA10_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101050104'])) ? ($result['RVRA10_VALUE1'] * $result['RVRA10_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA10_VALUE3'];
    $total_biaya2 += ($result['RVRA10_VALUE1'] * $result['RVRA10_VALUE2']* $total_qty_tahun );
    
    //FILTER UDARA
    $result['RVRA11_VALUE1'] = isset($rvra['qty_uom']['R550101050105']) ? $rvra['qty_uom']['R550101050105'] : 0;
    $result['RVRA11_VALUE2'] = isset($rvra['qty_uom']['R550101050105']) ? $rvra['harga']['R550101050105'] : 0;
    $result['RVRA11_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101050105'])) ? ($result['RVRA11_VALUE1'] * $result['RVRA11_VALUE2']) : 0;
    ...
    //GANTI BAN LUAR
    $result['RVRA13_VALUE1'] = isset($rvra['qty_uom']['R550101060101']) ? $rvra['qty_uom']['R550101060101'] : 0;
    $result['RVRA13_VALUE2'] = isset($rvra['qty_uom']['R550101060101']) ? $rvra['harga']['R550101060101'] : 0;
    //$result['RVRA13_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101060101'])) ? ($result['RVRA13_VALUE1'] * $result['RVRA13_VALUE2'] / $total_qty_tahun) : 0;
    $result['RVRA13_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101060101'])) ? ($result['RVRA13_VALUE1'] * $result['RVRA13_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA13_VALUE3'];
    $total_biaya2 += ($result['RVRA13_VALUE1'] * $result['RVRA13_VALUE2'] * $total_qty_tahun);
    
    //GANTI BAN DALAM
    $result['RVRA14_VALUE1'] = isset($rvra['qty_uom']['R550101060102']) ? $rvra['qty_uom']['R550101060102'] : 0;
    $result['RVRA14_VALUE2'] = isset($rvra['qty_uom']['R550101060102']) ? $rvra['harga']['R550101060102'] : 0;
    //$result['RVRA14_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101060102'])) ? ($result['RVRA14_VALUE1'] * $result['RVRA14_VALUE2'] / $total_qty_tahun) : 0;
    $result['RVRA14_VALUE3'] = ($total_qty_tahun && isset($rvra['qty_uom']['R550101060102'])) ? ($result['RVRA14_VALUE1'] * $result['RVRA14_VALUE2']) : 0;
    $total_rp_qty += $result['RVRA14_VALUE3'];
    $total_biaya2 += ($result['RVRA14_VALUE1'] * $result['RVRA14_VALUE2'] * $total_qty_tahun);
  ...
  public function cal_NormaAlatKerjaPanen_RpKg($params = array())
    ...
    //hitung prod dari perencanaan prod Aries (29082016)
    $sql = "SELECT SUM(AVGS) FROM(
        SELECT H1.PERIOD_BUDGET,
             H1.BA_CODE,
             H1.BLOCK_CODE,
             H1.TOPOGRAPHY,
             H1.TAHUN_TANAM,
             ...
             H1.TTL,
             NPP.VALUE,
             (H1.TON_BUDGET/H1.TTL) * VALUE AS AVGS
          FROM    (SELECT PB.PERIOD_BUDGET,
                  PB.BA_CODE,
                  PB.BLOCK_CODE,
                  HS.TOPOGRAPHY,
                  HS.TAHUN_TANAM,
                  PB.TON_BUDGET,
                  SUMTON.TTL,
                  TO_CHAR (PB.PERIOD_BUDGET, 'RRRR')
                  - TO_CHAR (HS.TAHUN_TANAM, 'RRRR')
                   UMUR
               FROM TR_PRODUKSI_PERIODE_BUDGET PB
                  LEFT JOIN TM_HECTARE_STATEMENT HS
                   ON     PB.PERIOD_BUDGET = HS.PERIOD_BUDGET
                    AND PB.BA_CODE = HS.BA_CODE
                    AND PB.AFD_CODE = HS.AFD_CODE
                    AND PB.BLOCK_CODE = HS.BLOCK_CODE
                  LEFT JOIN (  SELECT PERIOD_BUDGET,
                            BA_CODE,
                            SUM (TON_BUDGET) AS TTL
                         FROM TR_PRODUKSI_PERIODE_BUDGET
                       GROUP BY PERIOD_BUDGET, BA_CODE) SUMTON
                   ON PB.PERIOD_BUDGET = SUMTON.PERIOD_BUDGET
                    AND PB.BA_CODE = SUMTON.BA_CODE
              WHERE PB.PERIOD_BUDGET = TO_DATE('{$params['PERIOD_BUDGET']}','DD-MM-RRRR')
                  AND PB.BA_CODE = '".addslashes($params['BA_CODE'])."') H1
             LEFT JOIN
              TN_PANEN_PROD_PEMANEN NPP
             ON     H1.PERIOD_BUDGET = NPP.PERIOD_BUDGET
              AND H1.BA_CODE = NPP.BA_CODE
              AND H1.UMUR = NPP.UMUR
              AND H1.TOPOGRAPHY = NPP.TOPOGRAPHY
        )     
      ";
      
    $prod = $this->_db->fetchOne($sql);
  ...
  public function get_RktPanen_PemanenHK($params){
    ...
    */
    ...
    //Hitung umur tanam baru (aries)
    $date1_y = substr($res['TAHUN_TANAM'], -4);
    $date2_y = $params['PERIOD_BUDGET'];
    $selisih_tahun = (((int)($date2_y) - (int)($date1_y)));

    $umur_tanaman = round($selisih_tahun, 0, PHP_ROUND_HALF_DOWN);
  ...
  public function get_RktPanen_PemanenPremi($params){
    ...
    //Aries perhitungan BJR baru Edited : ASO 10/10/2016
    //$bjr = ($params['TON'] * 1000)/$params['JANJANG'];
    ...
    $sql = "SELECT  NVL(JANJANG_BASIS_MANDOR,0) as JANJANG_BASIS_MANDOR,
        ...
        WHERE PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR') 
          ...
          AND '".round($bjr, 2)."' BETWEEN BJR_MIN AND BJR_MAX
          AND DELETE_USER IS NULL";
    ...
    $premi_pemanen = ($params['JANJANG'] - ($oer['JANJANG_BASIS_MANDOR'] * $params['BIAYA_PEMANEN_HK'])) * $oer['PREMI_PANEN'];
    ...
    //PERUBAHAN PERHITUNGAN PREMI : NBU 08.05.2015
    $premi['PREMI_JANJANG'] = $premi_pemanen_tambahan; 
    $premi['PREMI_BRD'] = $premi_brondolan;
    
    $return['PREMI_JANJANG'] = ($premi['PREMI_JANJANG'] < 0) ? 0 : $premi['PREMI_JANJANG'];
    $return['PREMI_BRD'] = ($premi['PREMI_BRD'] < 0) ? 0 : $premi['PREMI_BRD'];
  ...
  /**
   * 01-08-2017
   * yaddi.surahman@tap-agrico.id
   * Perhitungan premi janjang lebih 2018
   */
  public function get_RktPanen_Premi2018($params)
  {
    $sql_1 = "SELECT DISTINCT JANJANG_BASIS_MANDOR, JANJANG_BASIS_MANDOR_JUMAT, PREMI_PANEN FROM TN_PANEN_OER_BJR
              WHERE ROUND(".addslashes($params['BJR_AFD'])." , 2) BETWEEN BJR_MIN AND BJR_MAX
              AND EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$params['PERIOD_BUDGET']."' AND BA_CODE = '".addslashes($params['BA_CODE'])."'";
    $janjang_basis_normal = $this->_db->fetchRow($sql_1);

    $sql_1a = "SELECT EXTRACT(YEAR FROM PERIOD_BUDGET) - EXTRACT(YEAR FROM TAHUN_TANAM) USIA_TANAM, TOPOGRAPHY
            FROM TM_HECTARE_STATEMENT
            WHERE PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR') 
            AND BA_CODE = '".addslashes($params['BA_CODE'])."' AND AFD_CODE = '".addslashes($params['AFD_CODE'])."' 
            AND BLOCK_CODE = '".addslashes($params['BLOCK_CODE'])."'";          
    $usia_tanaman = $this->_db->fetchRow($sql_1a);

    $sql_3 = "WITH HK_BASIS AS (
                SELECT ".$params['TON']."/(NVL(VALUE,0)/1000) NILAI_HK FROM TN_PANEN_PROD_PEMANEN WHERE DELETE_USER IS NULL
                AND PERIOD_BUDGET = TO_DATE('01-01-".$params['PERIOD_BUDGET']."','DD-MM-RRRR') 
                AND BA_CODE = '".addslashes($params['BA_CODE'])."' AND UMUR = '".addslashes($usia_tanaman['USIA_TANAM'])."' 
                AND TOPOGRAPHY = '".addslashes($usia_tanaman['TOPOGRAPHY'])."'
              )           
              SELECT NILAI_HK HK_BASIS, 
              NILAI_HK * (CAST(VALUE AS INT)/100) HK_BASIS_NORMAL,
              NILAI_HK - (NILAI_HK*(CAST(VALUE AS INT)/100)) HK_BASIS_JUMAT
              FROM TN_PANEN_VARIABLE, HK_BASIS
              WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = ".$params['PERIOD_BUDGET']." 
              AND BA_CODE = ".$params['BA_CODE']." AND PANEN_CODE = 'NORMA_HARI_JUMAT'";
    $hk_basis_all = $this->_db->fetchRow($sql_3);

    $rp_jjg = $janjang_basis_normal['PREMI_PANEN'];
    if($usia_tanaman['TOPOGRAPHY'] == 'BUKIT') {
      $sql_4 = "SELECT ".$janjang_basis_normal['PREMI_PANEN']." + (".$janjang_basis_normal['PREMI_PANEN']." * (NVL(PERCENTAGE,0)/100)) as RP_JJG
                FROM TN_PANEN_PREMI_TOPOGRAPHY
                WHERE DELETE_USER IS NULL AND PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR') 
                  AND BA_CODE = '".addslashes($params['BA_CODE'])."' 
                  AND AFD_CODE = '".addslashes($params['AFD_CODE'])."'";
      $result = $this->_db->fetchRow($sql_4);
      $rp_jjg = $result['RP_JJG'];
    }

    $janjang_basis['normal'] = $hk_basis_all['HK_BASIS_NORMAL']*$janjang_basis_normal['JANJANG_BASIS_MANDOR'];
    $janjang_basis['jumat'] = $hk_basis_all['HK_BASIS_JUMAT']*$janjang_basis_normal['JANJANG_BASIS_MANDOR_JUMAT'];
    $data['janjang_basis_normal'] = $janjang_basis_normal;
    $data['usia_tanaman'] = $usia_tanaman;
    $data['hk_basis_all'] = $hk_basis_all;
    $data['janjang_basis'] = $janjang_basis;
    $data['rp_jjg'] = $rp_jjg;
    $data['params'] = $params;
    $data['janjang_actual'] = array_sum($janjang_basis);

    if(($params['JANJANG'] - array_sum($janjang_basis)) > 0){
      $premi_2018 = ($params['JANJANG'] - array_sum($janjang_basis))  * $rp_jjg;
    } else {
      $premi_2018 = 0;
    }
    $data['premi_2018'] = $premi_2018;

    // tONASE SETAHUN * PERSENTASE BRONDOL
    $sql = "SELECT PANEN_CODE, NVL(VALUE,0) VALUE FROM TN_PANEN_VARIABLE
            WHERE PANEN_CODE IN ('PRES_BRONDOLAN', 'PRE_MAN_BRD')
            AND PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR')
            AND BA_CODE = '".addslashes($params['BA_CODE'])."'
            AND DELETE_USER IS NULL";
    $variable = $this->_db->fetchAll($sql);

    foreach ($variable as $key => $val) {
        $norma_panen[$val['PANEN_CODE']] = $val['VALUE'];
    }

    $premi_brondolan = ($norma_panen['PRES_BRONDOLAN']*$params['TON']*1000) * $norma_panen['PRE_MAN_BRD'];
    $data['premi_brondolan'] = $premi_brondolan;
   ...
   * Perhitungan premi insentif 2018
   */
  public function get_RktPanen_Incentive2018($params)
  {
    $sql_1 = "SELECT EXTRACT(YEAR FROM PERIOD_BUDGET) - EXTRACT(YEAR FROM TAHUN_TANAM) USIA_TANAM, TOPOGRAPHY
            FROM TM_HECTARE_STATEMENT
            WHERE PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR') 
            AND BA_CODE = '".addslashes($params['BA_CODE'])."' AND AFD_CODE = '".addslashes($params['AFD_CODE'])."' 
            AND BLOCK_CODE = '".addslashes($params['BLOCK_CODE'])."'";          
    $usia_tanaman = $this->_db->fetchRow($sql_1);

    // HK Basis
    $sql_2 = "SELECT NVL(VALUE,0)/1000 GUIDELINE FROM TN_PANEN_PROD_PEMANEN WHERE DELETE_USER IS NULL
            AND PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR') 
            AND BA_CODE = '".addslashes($params['BA_CODE'])."' AND UMUR = '".addslashes($usia_tanaman['USIA_TANAM'])."' 
            AND TOPOGRAPHY = '".addslashes($usia_tanaman['TOPOGRAPHY'])."'";

    $output_guidelines = $this->_db->fetchRow($sql_2);

    // Incentive Variable
    $sql_3 = "SELECT * FROM TN_INSENTIVE_PANEN WHERE PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR') 
            AND BA_CODE = '".addslashes($params['BA_CODE'])."'";
    $incentive = $this->_db->fetchRow($sql_3);

    $incentive_total = (intval($incentive['PERCENTAGE_INCENTIVE_1'])/100 * intval($incentive['INCENTIVE_1']) * ($params['TON']/$output_guidelines['GUIDELINE'])) +
                       (intval($incentive['PERCENTAGE_INCENTIVE_2'])/100 * intval($incentive['INCENTIVE_2']) * ($params['TON']/$output_guidelines['GUIDELINE'])) +
                       (intval($incentive['PERCENTAGE_INCENTIVE_3'])/100 * intval($incentive['INCENTIVE_3']) * ($params['TON']/$output_guidelines['GUIDELINE']));
  ...
  public function get_RktPanen_PemanenTotal($row){
    return $row['BIAYA_PEMANEN_RP_PREMI_JANJANG']+$row['BIAYA_PEMANEN_RP_PREMI_BRD']+$row['BIAYA_PEMANEN_RP_BASIS']+$row['INCENTIVE']; //perubahan total oleh NBU 04.06.2015
  }
  ...
  /**
   * Calculate SPV Premi based on 2018 rules
   * yaddi.surahman@tap-agri.co.id
   * 2018-08-09
   */
  public function get_SpvPremi_2018($params)
  {
    $sql_1 = "SELECT PREMI_MANDOR_PANEN, PREMI_MANDOR_1,
              (PREMI_MANDOR_PANEN * ".$params['TON'].") RP_PREMI_MANDOR, (PREMI_MANDOR_1 * ".$params['TON'].") RP_PREMI_MANDOR_1,
              (PREMI_MANDOR_PANEN * ".$params['TON'].") + (PREMI_MANDOR_1 * ".$params['TON'].") RP_PREMI
              FROM TN_PANEN_SUPERVISI_2017 WHERE  EXTRACT(YEAR FROM PERIOD_BUDGET) = '".$params['PERIOD_BUDGET']."'
              AND ROUND(".addslashes($params['BJR_AFD'])." , 2) BETWEEN BJR_MIN AND BJR_MAX";
    $premi_spv = $this->_db->fetchRow($sql_1);

    return $premi_spv['RP_PREMI'];
  }
...
/*    $sql = "
    ...
    //disuruh ganti lagi bagi 12 sama Yustinus 11.10.2016 by Aries
    $yield_ba = ($ton && $ha_planted) ? (($ton / $ha_planted) / 12) : 0;
    //$yield_ba = ($ton && $ha_planted) ? ($ton / $ha_planted) : 0;
  ...
  public function get_RktPanen_Angkut($params){
    if($params['SUMBER_BIAYA'] == 'INTERNAL') {
        ...
        $sql = "SELECT ANGKUT_TBS_RP_KG * TON * 1000 ANGKUT_TBS_RP_ANGKUT
                FROM TR_RKT_PANEN 
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = ".$params['PERIOD_BUDGET']."
                AND BA_CODE = '".addslashes($params['BA_CODE'])."' AND AFD_CODE = '".$params['AFD_CODE']."'
                AND BLOCK_CODE = '".$params['BLOCK_CODE']."'
                AND DELETE_USER IS NULL AND SUMBER_BIAYA_UNIT = 'EXTERNAL'";
        $res = $this->_db->fetchRow($sql);
        return $res['ANGKUT_TBS_RP_ANGKUT'];
    }
  ...
  public function get_RktPanen_AngkutKG($row){
    if($row['SUMBER_BIAYA'] == 'INTERNAL') {
        return ($row['ANGKUT_TBS_RP_KG_KM'] * $row['JARAK_PKS']);
    } else {
        $sql = "SELECT ANGKUT_TBS_RP_KG
                FROM TR_RKT_PANEN 
                WHERE EXTRACT(YEAR FROM PERIOD_BUDGET) = ".$row['PERIOD_BUDGET']."
                AND BA_CODE = '".addslashes($row['BA_CODE'])."' AND AFD_CODE = '".$row['AFD_CODE']."'
                AND BLOCK_CODE = '".$row['BLOCK_CODE']."'
                AND DELETE_USER IS NULL AND SUMBER_BIAYA_UNIT = 'EXTERNAL'";
        $res = $this->_db->fetchRow($sql);
        return $res['ANGKUT_TBS_RP_KG'];
    }
  }
  ...
  public function get_RktPanen_KraniPremi($params){
    ...
    // YUS 27/11/2014
    //tambah kondisi jika basis 0 , maka premi 0 jg
    $sql = "
      SELECT TOTAL_GAJI_TUNJANGAN, MPP_PERIOD_BUDGET
      FROM TR_RKT_CHECKROLL
      WHERE PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR') 
  ...
  public function get_RktLangsir_TkgMuat($params)
  {
    $sql = "
      SELECT VALUE
      FROM TN_PANEN_VARIABLE
      WHERE DELETE_USER IS NULL
        AND PANEN_CODE = 'LANGSIR_TUKANG_MUAT'
        AND PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR')
        AND BA_CODE = '".addslashes($params['BA_CODE'])."'";
    
    $rpkg = $this->_db->fetchOne($sql);
    
    return ($params['TON']*($params['PERSEN_LANGSIR']/100)*1000)*$rpkg;
  }
  
  public function get_RktPanen_LangsirKg($row){

    return ($row['LANGSIR_TON']!=0)? (($row['LANGSIR_RP']+$row['LANGSIR_TUKANG_MUAT'])/($row['LANGSIR_TON']*1000)):0;
  }
  ...
  public function cal_RktPanen_Distribusi($params){
    ...
    $sql = "SELECT norma.JAN JAN, norma.FEB FEB, norma.MAR MAR, norma.APR APR, norma.MAY MAY, norma.JUN JUN,  
             norma.JUL JUL, norma.AUG AUG, norma.SEP SEP, norma.OCT OCT, norma.NOV NOV, norma.DEC DEC,  
            (norma.JAN + norma.FEB+ norma.MAR +
        ...
        WHERE norma.DELETE_USER IS NULL
          ...
          AND UPPER(norma.BA_CODE) LIKE UPPER('%".addslashes($params['BA_CODE'])."%')
          AND NORMA.AFD_CODE LIKE '".addslashes($params['AFD_CODEHS'])."'
          AND norma.BLOCK_CODE LIKE '".addslashes($params['BLOCK_CODEHS'])."'             
        ORDER BY norma.BA_CODE, norma.AFD_CODE, norma.BLOCK_CODE
    ";
    $prncn_prod = $this->_db->fetchRow($sql);
    
    $sebaran['JAN'] = ($prncn_prod['JAN']/$prncn_prod['TOTAL']); 
    $sebaran['FEB'] = ($prncn_prod['FEB']/$prncn_prod['TOTAL']); 
    $sebaran['MAR'] = ($prncn_prod['MAR']/$prncn_prod['TOTAL']); 
    $sebaran['APR'] = ($prncn_prod['APR']/$prncn_prod['TOTAL']); 
    $sebaran['MAY'] = ($prncn_prod['MAY']/$prncn_prod['TOTAL']); 
    $sebaran['JUN'] = ($prncn_prod['JUN']/$prncn_prod['TOTAL']); 
    $sebaran['JUL'] = ($prncn_prod['JUL']/$prncn_prod['TOTAL']); 
    $sebaran['AUG'] = ($prncn_prod['AUG']/$prncn_prod['TOTAL']); 
    $sebaran['SEP'] = ($prncn_prod['SEP']/$prncn_prod['TOTAL']); 
    $sebaran['OCT'] = ($prncn_prod['OCT']/$prncn_prod['TOTAL']); 
    $sebaran['NOV'] = ($prncn_prod['NOV']/$prncn_prod['TOTAL']); 
    $sebaran['DEC'] = ($prncn_prod['DEC']/$prncn_prod['TOTAL']); 
    
    $result['COST_JAN'] = $sebaran['JAN'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_JAN']; $total_sms1 += $result['COST_JAN'];
    $result['COST_FEB'] = $sebaran['FEB'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_FEB']; $total_sms1 += $result['COST_FEB'];
    $result['COST_MAR'] = $sebaran['MAR'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_MAR']; $total_sms1 += $result['COST_MAR'];
    $result['COST_APR'] = $sebaran['APR'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_APR']; $total_sms1 += $result['COST_APR'];
    $result['COST_MAY'] = $sebaran['MAY'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_MAY']; $total_sms1 += $result['COST_MAY'];
    $result['COST_JUN'] = $sebaran['JUN'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_JUN']; $total_sms1 += $result['COST_JUN'];
    $result['COST_JUL'] = $sebaran['JUL'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_JUL']; $total_sms2 += $result['COST_JUL'];
    $result['COST_AUG'] = $sebaran['AUG'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_AUG']; $total_sms2 += $result['COST_AUG'];
    $result['COST_SEP'] = $sebaran['SEP'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_SEP']; $total_sms2 += $result['COST_SEP'];
    $result['COST_OCT'] = $sebaran['OCT'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_OCT']; $total_sms2 += $result['COST_OCT'];
    $result['COST_NOV'] = $sebaran['NOV'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_NOV']; $total_sms2 += $result['COST_NOV'];
    $result['COST_DEC'] = $sebaran['DEC'] * $params['TOTAL_COST_ELEMENT']; $total += $result['COST_DEC']; $total_sms2 += $result['COST_DEC'];
  ...
  public function cal_RktManual_CostElement($costElement, $params = array())
    ...
    elseif($costElement == 'CONTRACT'){
      if($params['TIPE_NORMA'] == 'UMUM'){
        ...
        //ini untuk biaya external
        $sql = "
          SELECT ACTIVITY_CLASS, PRICE AS PRICE_ROTASI
          FROM TN_HARGA_BORONG
          WHERE DELETE_USER IS NULL
            AND PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR')
            AND BA_CODE = '".addslashes($params['BA_CODE'])."'
  ...
  //cost total RKT Manual Sisip
  public function cal_RktManualSisip_CostElement($costElement, $params = array())
    {
    //<!-- TIPE NORMA -->
    if($costElement == 'LABOUR'){
      if($params['TIPE_NORMA'] == 'UMUM'){
    ...
    elseif($costElement == 'TRANSPORT'){
      $sql = "
        ...
        WHERE PERIOD_BUDGET = TO_DATE('01-01-{$params['PERIOD_BUDGET']}','DD-MM-RRRR')
          ...
          AND AFD_CODE = '".addslashes($params['AFD_CODE'])."'
          AND ACTIVITY_CODE = '".addslashes($params['ACTIVITY_CODE'])."'
          AND TIPE_TRANSAKSI = 'MANUAL_SISIP'
      ";
      $total_rotasi_per_afd = $this->_db->fetchOne($sql);
  ...
  public function cal_RktManual_TotalTanam($params = array())
    ...
    if($params['ACTIVITY_CODE'] != '40300'){
      ...
      $cost_jan = $PLAN_JAN * $params['MON_JAN']; $result['COST_JAN'] = $cost_jan;  $total_cost += $cost_jan; $cost_sms1 += $cost_jan;
      $cost_feb = $PLAN_FEB * $params['MON_FEB']; $result['COST_FEB'] = $cost_feb;  $total_cost += $cost_feb; $cost_sms1 += $cost_feb;
      $cost_mar = $PLAN_MAR * $params['MON_MAR']; $result['COST_MAR'] = $cost_mar;  $total_cost += $cost_mar; $cost_sms1 += $cost_mar;
      $cost_apr = $PLAN_APR * $params['MON_APR']; $result['COST_APR'] = $cost_apr;  $total_cost += $cost_apr; $cost_sms1 += $cost_apr;
      $cost_may = $PLAN_MAY * $params['MON_MAY']; $result['COST_MAY'] = $cost_may;  $total_cost += $cost_may; $cost_sms1 += $cost_may;
      $cost_jun = $PLAN_JUN * $params['MON_JUN']; $result['COST_JUN'] = $cost_jun;  $total_cost += $cost_jun; $cost_sms1 += $cost_jun;
      $cost_jul = $PLAN_JUL * $params['MON_JUL']; $result['COST_JUL'] = $cost_jul;  $total_cost += $cost_jul; $cost_sms2 += $cost_jul;
      $cost_aug = $PLAN_AUG * $params['MON_AUG']; $result['COST_AUG'] = $cost_aug;  $total_cost += $cost_aug; $cost_sms2 += $cost_aug;
      $cost_sep = $PLAN_SEP * $params['MON_SEP']; $result['COST_SEP'] = $cost_sep;  $total_cost += $cost_sep; $cost_sms2 += $cost_sep;
      $cost_oct = $PLAN_OCT * $params['MON_OCT']; $result['COST_OCT'] = $cost_oct;  $total_cost += $cost_oct; $cost_sms2 += $cost_oct;
      $cost_nov = $PLAN_NOV * $params['MON_NOV']; $result['COST_NOV'] = $cost_nov;  $total_cost += $cost_nov; $cost_sms2 += $cost_nov;
      $cost_dec = $PLAN_DEC * $params['MON_DEC']; $result['COST_DEC'] = $cost_dec;  $total_cost += $cost_dec; $cost_sms2 += $cost_dec;
    }
  ...
  public function cal_RktManual_CostElementTanam($costElement, $params = array())
        ...
        if($params['ACTIVITY_CODE'] != '40300'){
          ...
          for($i = 1;$i <= 6; $i++){
            ...
            if($params['TAHUN_TANAM_M'] == '01'){
              ...
              $count = $params['TAHUN_TANAM_M'] - 1;
              $nextNoM = $count + $i;
            }
            $nextM =  strtoupper(date("M",mktime(0,0,0,$nextNoM,1,0)));
            
            $cost_labour_sms1 = ($params['SUMBER_BIAYA'] == 'INTERNAL') ? $res['PRICE_ROTASI'] : 0;
            $row['PLAN_'.$nextNoM] = $cost_labour_sms1;
            $result[1] = $cost_labour_sms1;
          }
          //LABOUR SMS 2
          for($i = 7;$i <= 12; $i++){
      ...
      if($params['TIPE_NORMA'] == 'UMUM'){
        if($params['ACTIVITY_CODE'] != '40300'){
          ...
          for($i = 1;$i <= 6; $i++){
            ...
            $cost_labour_sms1 = $res['PRICE_ROTASI'];
            $row['PLAN_'.$nextNoM] = $cost_labour_sms1;
            $result[1] = $cost_labour_sms1;
          }
          //MATERIAL SMS 2
          for($i = 7;$i <= 12; $i++){
            ...
            $cost_labour_sms2 = $res['PRICE_ROTASI'];
            $row['PLAN_'.$nextNoM] = $cost_labour_sms2;
            $result[2] = $cost_labour_sms2;
          }
          for ($mBudget = $row['TAHUN_TANAM_M']; $mBudget <= 12 ; $mBudget++){
    ...
    elseif($costElement == 'TRANSPORT'){
      ...
      ";*/
      $sql="
        SELECT SUM(NVL(TRRKT.PLAN_JAN,0))+SUM(NVL(TRRKT.PLAN_FEB,0))+SUM(NVL(TRRKT.PLAN_MAR,0))+SUM(NVL(TRRKT.PLAN_APR,0))+
             SUM(NVL(TRRKT.PLAN_MAY,0))+SUM(NVL(TRRKT.PLAN_JUN,0))+SUM(NVL(TRRKT.PLAN_JUL,0))+SUM(NVL(TRRKT.PLAN_AUG,0))+
             SUM(NVL(TRRKT.PLAN_SEP,0))+SUM(NVL(TRRKT.PLAN_OCT,0))+SUM(NVL(TRRKT.PLAN_NOV,0))+SUM(NVL(TRRKT.PLAN_DEC,0)) AS PLAN_SETAHUN
          FROM    TR_RKT TRRKT
             LEFT JOIN
              TR_RKT_VRA_DISTRIBUSI TRVD
             ON     TRRKT.PERIOD_BUDGET = TRVD.PERIOD_BUDGET
              AND TRRKT.BA_CODE = TRVD.BA_CODE
              AND TRRKT.AFD_CODE = TRVD.LOCATION_CODE
              AND TRRKT.ACTIVITY_CODE = TRVD.ACTIVITY_CODE
         WHERE     TRRKT.TIPE_TRANSAKSI = 'TANAM_MANUAL'
             AND TRRKT.PERIOD_BUDGET = TO_DATE ('01-01-{$params['PERIOD_BUDGET']}', 'DD-MM-RRRR')
             AND TRRKT.BA_CODE = '".addslashes($params['BA_CODE'])."'
             AND TRRKT.DELETE_USER IS NULL
             AND TRRKT.ACTIVITY_CODE = '".addslashes($params['ACTIVITY_CODE'])."'
             AND TRVD.HM_KM <> 0
      ";
      $planTotalYear = $this->_db->fetchOne($sql);
      
      $query = "SELECT DISTINCT(LOCATION_CODE) from TR_RKT_VRA_DISTRIBUSI TRVD 
            WHERE TRVD.PERIOD_BUDGET = TO_DATE ('01-01-{$params['PERIOD_BUDGET']}', 'DD-MM-RRRR')
             AND TRVD.BA_CODE = '".addslashes($params['BA_CODE'])."'
             AND TRVD.DELETE_USER IS NULL
             AND TRVD.ACTIVITY_CODE = '".addslashes($params['ACTIVITY_CODE'])."'
            AND TRVD.HM_KM <> 0";
      $incl_afd = $this->_db->fetchAll($query);
      
      $status = 0;
      for($i = 0; $i < count($incl_afd); $i++){
        if($params['AFD_CODE'] == $incl_afd[$i]['LOCATION_CODE']){
          $status = 1;
        }
      }
      if($planTotalYear>0) {
        ...
        if($params['ACTIVITY_CODE'] != '40300'){
          ...
          $result[2] = $cost_trperhm;
          if($status == 1){
            $result['PLAN_JAN'] = $cost_trperhm;$result['PLAN_FEB'] = $cost_trperhm;$result['PLAN_MAR'] = $cost_trperhm;
            $result['PLAN_APR'] = $cost_trperhm;$result['PLAN_MAY'] = $cost_trperhm;$result['PLAN_JUN'] = $cost_trperhm;
            $result['PLAN_JUL'] = $cost_trperhm;$result['PLAN_AUG'] = $cost_trperhm;$result['PLAN_SEP'] = $cost_trperhm;
            $result['PLAN_OCT'] = $cost_trperhm;$result['PLAN_NOV'] = $cost_trperhm;$result['PLAN_DEC'] = $cost_trperhm;  
          }else{
            $result['PLAN_JAN'] = 0;$result['PLAN_FEB'] = 0;$result['PLAN_MAR'] = 0;
            $result['PLAN_APR'] = 0;$result['PLAN_MAY'] = 0;$result['PLAN_JUN'] = 0;
            $result['PLAN_JUL'] = 0;$result['PLAN_AUG'] = 0;$result['PLAN_SEP'] = 0;
            $result['PLAN_OCT'] = 0;$result['PLAN_NOV'] = 0;$result['PLAN_DEC'] = 0;
          }
        }
      }else{
        $result[1] = 0;
  ...
  public function cal_costElement_RktTanam($costElement, $params = array())
    ...
    if($costElement == 'LABOUR') {
      ...
      if($params['TIPE_NORMA'] == 'UMUM'){
        ...
        $res = $this->_db->fetchAll($sql);
        if (!empty($res)) {
          foreach ($res as $idx1 => $res1) {
            $cost_labour_sms1 += ($params['SUMBER_BIAYA'] == 'INTERNAL') ? $res1['PRICE_ROTASI'] : 0;
          }
        }   
        $result[1] = $cost_labour_sms1;
        ...
        if (!empty($res)) {
          foreach ($res as $idx1 => $res1) {
            $cost_labour_sms2 += ($params['SUMBER_BIAYA'] == 'INTERNAL') ? $res1['PRICE_ROTASI'] : 0;
          }
        }$result[2] = $cost_labour_sms2;
      }elseif($params['TIPE_NORMA'] == 'KHUSUS'){
        //LABOUR SMS 1
  ...
  public function cal_KonversiPokokHa($record = array()){
    if (substr($record['BA_CODE'],2,1) == 2){
      $core = "INTI";
    }else{
      $core = "PLASMA";
    }
    $sql = "
        ...
        AND TOPOGRAPHY = '".$record['TOPOGRAPHY']."' 
        AND DELETE_USER IS NULL";
    $return = $this->_db->fetchRow($sql);
    return $return;
  }
