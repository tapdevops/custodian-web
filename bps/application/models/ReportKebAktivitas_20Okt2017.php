 ...
 WHERE     RKT.COA_CODE = '43800'
   ...
   --ini untuk PUPUK MAJEMUK TOOLS
    ...
    $devcost_components['labour_pupuk_tunggal_majemuk'] = "
      ...
      SELECT PIV.*, 
        PIV.JAN_DIS+PIV.FEB_DIS+PIV.MAR_DIS+PIV.APR_DIS+PIV.MAY_DIS+PIV.JUN_DIS+
        PIV.JUL_DIS+PIV.AUG_DIS+PIV.SEP_DIS+PIV.OCT_DIS+PIV.NOV_DIS+PIV.DEC_DIS DIS_SETAHUN,
        PIV.JAN_COST+PIV.FEB_COST+PIV.MAR_COST+PIV.APR_COST+PIV.MAY_COST+PIV.JUN_COST+
        PIV.JUL_COST+PIV.AUG_COST+PIV.SEP_COST+PIV.OCT_COST+PIV.NOV_COST+PIV.DEC_COST COST_SETAHUN,
        '".$this->_userName."', CURRENT_TIMESTAMP
      FROM (
        SELECT * FROM (
