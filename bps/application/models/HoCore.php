...
=========================================================================================================================
*/
class Application_Model_HoCore
{
    private $_db = null;
    ...
    public function getList($params = array()) {
        ...
        if ($params['key_find'] != '') {
            $query .= "
                AND (
                    UPPER(CORE_CODE) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(CORE_NAME) LIKE UPPER('%".$params['key_find']."%')
                )
            ";
        }
    ...
    { 
        ...
        $core_name = (empty($row['CORE_NAME'])) ? '' : str_replace(array('.', "'", '&'), array('', "''", '\'||\'&\'||\''), $row['CORE_NAME']);
        $core_code = (empty($row['CORE_CODE'])) ? '' : str_replace(array('.', "'", '&'), array('', "''", '\'||\'&\'||\''), $row['CORE_CODE']);
