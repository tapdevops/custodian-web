...
=========================================================================================================================
*/
class Application_Model_HoHaStatement
{
    private $_db = null;
    ...
    public function getList($params = array()) {
        ...
        if ($params['key_find'] != '') {
            $query .= "
                AND (
                    UPPER(EST_NAME) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(TBM) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(TM) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(GRAND_TOTAL) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(PERSEN_TBM) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(PERSEN_TM) LIKE UPPER('%".$params['key_find']."%')
                )
            ";
        }
    ...
    { 
        ...
        $est_name = (empty($row['EST_NAME'])) ? '' : str_replace(array('.', "'", '&'), array('', "''", '\'||\'&\'||\''), $row['EST_NAME']);
        ...
        $sql = "
            ...
            SET 
                ...
                PERSEN_TBM = '{$row['PERSEN_TBM']}',
                PERSEN_TM = '{$row['PERSEN_TM']}',
