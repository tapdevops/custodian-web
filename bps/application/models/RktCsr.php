...
Versi				: 	2.0.0
Deskripsi			: 	Model Class untuk RKT CSR
Function 			:	- getInput					: YIR 20/06/2014	: setting input untuk region dan COA
						...
						- getList					: SID 15/07/2013	: menampilkan list RKT CSR
						- save						: SID 15/07/2013	: simpan data
						- saveTemp					: SID 15/07/2013	: hapus data di RKT CSR, insert inputan user di RKT CSR
...
=========================================================================================================================
*/
class Application_Model_RktCsr
{
    private $_db = null;
	...
	public function getInput()
    {
		...
		$options['optCoa'] = $table->getCoaRelation('csr');
