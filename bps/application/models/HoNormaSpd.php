...
=========================================================================================================================
*/
class Application_Model_HoNormaSpd
{
    private $_db = null;
    ...
    public function getList($params = array()) {
        ...
        if ($params['key_find'] != '') {
            $query .= "
                AND (
                    UPPER(RUTE) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(DARI) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(TUJUAN) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(PLANE_QTY) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(PLANE_N_PRICE) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(PLANE_P_PRICE) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(TAXI_QTY) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(TAXI_N_PRICE) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(TAXI_P_PRICE) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(CHARTER_QTY) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(CHARTER_N_PRICE) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(CHARTER_P_PRICE) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(WATER_VEH_QTY) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(WATER_VEH_N_PRICE) LIKE UPPER('%".$params['key_find']."')
                    OR UPPER(WATER_VEH_P_PRICE) LIKE UPPER('%".$params['key_find']."')
                )
            ";
        }
