...
Versi				: 	2.0.0
Deskripsi			: 	Model Class untuk RKT Internal Relation
Function 			:	- getInput					: YIR 20/06/2014	: setting input untuk region dan COA
						...
						- getList					: SID 15/07/2013	: menampilkan list RKT IR
						- save						: SID 15/07/2013	: simpan data
						- saveTemp					: SID 15/07/2013	: hapus data di RKT IR, insert inputan user di RKT IR
...
=========================================================================================================================
*/
class Application_Model_RktInternalRelation
{
    private $_db = null;
	...
	public function getInput()
    {
		...
		$options['optCoa'] = $table->getCoaRelation('ir');
