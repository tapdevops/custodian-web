...
Versi				: 	1.0.0
Deskripsi			: 	Model Class untuk Site Norma Setting
Function 			:	- initSiteNormaSetting	: ambil data site norma setting dari DB
						- getList				: menampilkan list norma setting
...
=========================================================================================================================
*/
class Application_Model_SiteNormaSetting
{
    private $_db = null;
	...
	//ambil data site norma setting dari DB
	private function initSiteNormaSetting($params = array())
    {
        $result = array();
