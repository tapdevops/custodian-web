...
=========================================================================================================================
*/
class Application_Model_HoStandarSpd
{
    private $_db = null;
    ...
    public function getList($params = array()) {
        ...
        if ($params['key_find'] != '') {
            $query .= "
                AND (
                    UPPER(GOLONGAN) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(TRANSPORT_LAIN) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(UANG_MAKAN) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(UANG_SAKU) LIKE UPPER('%".$params['key_find']."%')
                    OR UPPER(HOTEL) LIKE UPPER('%".$params['key_find']."')
                )
            ";
        }
