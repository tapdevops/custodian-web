...
Versi				: 	1.0.0
Deskripsi			: 	Model Class untuk Norma Setting
Function 			:	- initNormaSetting	: ambil data norma setting dari DB
...
=========================================================================================================================
*/
class Application_Model_NormaSetting
{
    private $_db = null;
	...
	//ambil data norma setting dari DB
	private function initNormaSetting($params = array())
    {
        $result = array();
