...
=========================================================================================================================
*/
class Application_Model_HoOpex
{
    private $_db = null;
    ...
    public function saveTemp($row = array())
    {
        ...
        //$opex_desc = str_replace('&', "'||'&'||'", $row['OPEX_DESCRIPTION']);
        ...
        $opex_desc = (empty($row['OPEX_DESCRIPTION'])) ? '' : str_replace(array('.', "'", '&'), array('', "''", '\'||\'&\'||\''), $row['OPEX_DESCRIPTION']);

        $check = "
            SELECT * FROM TM_HO_OPEX
        ...
        if ($count > 0) {
            $sql = "
                ...
                SET 
                    ...
                    OPEX_JAN = '{$row['OPEX_JAN']}',
                    OPEX_FEB = '{$row['OPEX_FEB']}',
                    OPEX_MAR = '{$row['OPEX_MAR']}',
                    OPEX_APR = '{$row['OPEX_APR']}',
                    OPEX_MAY = '{$row['OPEX_MAY']}',
                    OPEX_JUN = '{$row['OPEX_JUN']}',
                    OPEX_JUL = '{$row['OPEX_JUL']}',
                    OPEX_AUG = '{$row['OPEX_AUG']}',
                    OPEX_SEP = '{$row['OPEX_SEP']}',
                    OPEX_OCT = '{$row['OPEX_OCT']}',
                    OPEX_NOV = '{$row['OPEX_NOV']}',
                    OPEX_DEC = '{$row['OPEX_DEC']}',
                    OPEX_TOTAL = '{$row['OPEX_TOTAL']}',
    ...
    public function getData($params = array()) {
        ...
        if ($params['src_cc'] != '') {
            ...
            $query .= "
                AND UPPER(CPX.CC_CODE) LIKE UPPER('%".trim($explode[0])."%')
            ";
        }
        ...
        if ($params['search'] != '') {
            $query .= "
                AND (
                    ...
                    OR UPPER(CPX.OPEX_DESCRIPTION) LIKE UPPER('%".$params['search']."%')
