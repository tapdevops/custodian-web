...
$appQuery=(($act=='approve')&&($approver=="1"))?"AND a.A_ApproverID='$mv_UserID'":"AND a.A_Status='2'";
...
$MainContent .="<tr>
	...
	<td colspan='2'>
		...
		if($arr['THLOLAD_DocumentType'] != "SOFTCOPY"){
			...
			$MainContent .="<input id='txtTHLOLAD_SoftcopyReceiver' name='txtTHLOLAD_SoftcopyReceiver' type='hidden' value='THLOLAD_SoftcopyReceiver'/>
			$arr[THLOLAD_SoftcopyReceiver]";
		}
	$MainContent .="</td>
</tr>
<tr>
				...
				for($i=0;$i<$jumlah;$i++){
					...
					$sql1 = "UPDATE TD_LoanOfLandAcquisitionDocument
								SET TDLOLAD_Code ='$CT_Code',TDLOLAD_Update_Time=sysdate(),
									TDLOLAD_Update_UserID='$mv_UserID'
