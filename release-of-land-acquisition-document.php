...
if(isset($_GET["act"]))
{
	...
	if($act=='add') {
		...
		<tr>
			<td width='30'>Nama</td>
			<td width='70%'>
				<input id='txtTHRLOLAD_UserID' type='hidden' value='$mv_UserID'/>
				$field[FullName]
			</td>
		</tr>
		<tr>
...
elseif(isset($_POST[canceldetail])) {
	$cd_query="UPDATE M_CodeTransaction ct, TH_ReleaseOfLandAcquisitionDocument thrlolad
			   SET ct.CT_Delete_UserID='$mv_UserID',ct.CT_Delete_Time=sysdate(),
			       ...
			       thrlolad.THRLOLAD_Delete_UserID='$mv_UserID',thrlolad.THRLOLAD_Delete_Time=sysdate(),
			       thrlolad.THRLOLAD_Update_UserID='$mv_UserID',thrlolad.THRLOLAD_Update_Time=sysdate()
...
elseif(isset($_POST[addheader])) {
	...
	if($mysqli->query($sql)) {
		...
		$sql1= "INSERT INTO TH_ReleaseOfLandAcquisitionDocument
				VALUES (NULL,'$CT_Code',sysdate(),'$mv_UserID','$_POST[txtTHRLOLAD_THLOLAD_Code]',
	...
	for ($i=0 ; $i<$sum ; $i++) {
		...
		$sql1= "INSERT INTO TD_ReleaseOfLandAcquisitionDocument
				VALUES (NULL,NULL,'$_POST[txtTDRLOLAD_THRLOLAD_ID]', '$TDLOLAD_ID[$i]','$txtTDRLOLAD_Information[$i]',
						'$TDRLOLAD_LeadTime',NULL,'$mv_UserID', sysdate(),'$mv_UserID',
						sysdate(),NULL,NULL)";
		$sql2= "UPDATE TD_LoanOfLandAcquisitionDocument
				SET TDLOLAD_Response='1', TDLOLAD_Update_UserID='$mv_UserID',TDLOLAD_Update_Time=sysdate()
