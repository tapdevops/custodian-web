...
if(isset($_POST[approval])) {
	...
	if ($A_Status=='3') {
		...
		if ($step <> $jStep) {
			...
			if ($_POST['txtDL_GroupDocID'] == '1' && $_POST['optTHLOLAD_LoanCategoryID'] != '3') { $jenis = '1'; }
			else if ($_POST['txtDL_GroupDocID'] == '1' && $_POST['optTHLOLAD_LoanCategoryID'] == '3') { $jenis = '2'; }
			else if ($_POST['txtDL_GroupDocID'] == '2' && $_POST['optTHLOLAD_LoanCategoryID'] != '3') { $jenis = '3'; }
			else if ($_POST['txtDL_GroupDocID'] == '2' && $_POST['optTHLOLAD_LoanCategoryID'] == '3') { $jenis = '4'; }
			else;
