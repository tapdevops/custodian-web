...
$new_field_id 			= 'mynewfield2'; 
$new_field_name 		= "Jaksel Field"; 
$new_field_farm_id 		= 'F-1234-14-B'; 
$new_field_latitude 	= -2.689048;
$new_field_longitude 	= 111.622441; 
$new_field_acres 		= 120; 

$observed_weather_start = "2015-10-20";
$observed_weather_end = "2015-10-25"; 

$forecast_weather_start = date("Y-m-d"); 
$forecast_weather_end = date("Y-m-d",strtotime("+ 3 days")); 

$new_palnting_id 	= "mynewPlanting1"; 
$new_plantingDate 	= "2015-11-03"; 
