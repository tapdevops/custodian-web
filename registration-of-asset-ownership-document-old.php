...
function validateInputDetail(elem) {
	...
	for (i = 1; i <= jrow; i++){
		...
		var txtTDROAOD_Location = document.getElementById('txtTDROAOD_Location' + i).value;
...
if(isset($_GET["act"]))
{
	...
	elseif($act=='adddetail')	{
		...
		$query5="SELECT Employee_NIK AS id, Employee_FullName AS name, Employee_CompanyCode AS Company_Code
